...
.LFB5559:
	...
	movabsq	$12884901889, %r8
	movabsq	$30064771077, %rdi
	movabsq	$47244640265, %rsi
	movabsq	$64424509453, %rcx
	movl	$9999999, %r9d
.L98:
#APP
# 12 "AIC3.c" 1
...
#NO_APP
	...
	subq	%rdx, %r10
	movq	%r10, elapsed(%rip)
	movq	%rax, %r10
.L96:
	addq	ttime(%rip), %rax
	leaq	-1(%rdx), %r11
	movq	%rax, ttime(%rip)
	movq	%r11, elapsed_rdtsc(%rip)
	testq	%rdx, %rdx
	je	.L99
