...
# mark_description "-D _GNU_SOURCE -O3 -xHOST -S -c -o AIC1icc.s";
	.file "AIC1.c"
	.text
..TXTST0:
...
..B1.3:                         # Preds ..B1.2
        ...
        movq      $0x4a817c7ff, %rax                            #11.2
        movq      $.L_2__STRING.8, programName(%rip)            #9.2
        movq      $9999999, elapsed_rdtsc(%rip)                 #11.2
        movq      %rax, overal_time(%rip)                       #11.2
        movq      $0, ttime(%rip)                               #11.2
                                # LOE rbx r12 r13 r14 r15
...
..B1.5:                         # Preds ..B1.23
                                # Execution count [2.91e+00]
        movq      %rax, t1_rdtsc(%rip)                          #11.2
        xorl      %ecx, %ecx                                    #17.2
        movl      $1, a(%rip)                                   #16.5
        movl      $1, %edx                                      #17.2
        movl      $3, %eax                                      #14.7
                                # LOE rcx rbx r12 r13 r14 r15 eax edx
..B1.6:                         # Preds ..B1.6 ..B1.5
                                # Execution count [5.95e+03]
        addl      $4, %edx                                      #18.18
        movl      %eax, 4+a(,%rcx,8)                            #18.3
        addl      $4, %eax                                      #18.18
        movl      %edx, 8+a(,%rcx,8)                            #18.3
        incq      %rcx                                          #17.2
        cmpq      $2047, %rcx                                   #17.2
        jb        ..B1.6        # Prob 99%                      #17.2
                                # LOE rcx rbx r12 r13 r14 r15 eax edx
..B1.7:                         # Preds ..B1.6
                                # Execution count [2.91e+00]
        movl      16376+a(%rip), %eax                           #18.10
        addl      $2, %eax                                      #18.18
        movl      %eax, 16380+a(%rip)                           #18.3
        rdtsc                                                   #19.2
        shlq      $32, %rdx                                     #19.2
        orq       %rdx, %rax                                    #19.2
                                # LOE rax rbx r12 r13 r14 r15
...
..B1.25:                        # Preds ..B1.26
                                # Execution count [2.91e+00]
        movq      t2_rdtsc(%rip), %rdx                          #19.2
        subq      t1_rdtsc(%rip), %rdx                          #19.2
        movq      ttbest_rdtsc(%rip), %rsi                      #19.2
        movq      %rdx, ttotal_rdtsc(%rip)                      #19.2
        cmpq      %rsi, %rdx                                    #19.2
        jge       ..B1.10       # Prob 50%                      #19.2
                                # LOE rdx rbx rsi r12 r13 r14 r15
..B1.9:                         # Preds ..B1.25
                                # Execution count [1.45e+00]
        movq      elapsed_rdtsc(%rip), %rcx                     #19.2
        movq      %rcx, %rax                                    #19.2
        negq      %rax                                          #19.2
        movq      %rdx, %rsi                                    #19.2
        addq      $9999999, %rax                                #19.2
        movq      %rdx, ttbest_rdtsc(%rip)                      #19.2
        movq      %rax, elapsed(%rip)                           #19.2
        jmp       ..B1.11       # Prob 100%                     #19.2
...
..B1.11:                        # Preds ..B1.9 ..B1.10
                                # Execution count [2.91e+00]
        movq      ttime(%rip), %rax                             #19.2
        addq      %rdx, %rax                                    #19.2
        movq      %rax, ttime(%rip)                             #19.2
        testq     %rcx, %rcx                                    #19.2
        je        ..B1.14       # Prob 50%                      #19.2
                                # LOE rax rcx rbx rsi r12 r13 r14 r15
..B1.12:                        # Preds ..B1.11
                                # Execution count [1.45e+00]
        decq      %rcx                                          #19.2
        movq      %rcx, elapsed_rdtsc(%rip)                     #19.2
        cmpq      overal_time(%rip), %rax                       #19.2
        jl        ..B1.4        # Prob 82%                      #19.2
        jmp       ..B1.15       # Prob 100%                     #19.2
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.14:                        # Preds ..B1.11
                                # Execution count [1.45e+00]
        movq      $-1, elapsed_rdtsc(%rip)                      #19.2
        movq      $-1, %rcx                                     #19.2
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.15:                        # Preds ..B1.12 ..B1.14
                                # Execution count [1.00e+00]
        negq      %rcx                                          #19.2
        movl      $.L_2__STRING.9, %edi                         #19.2
        addq      $9999999, %rcx                                #19.2
        xorl      %eax, %eax                                    #19.2
        movq      elapsed(%rip), %rdx                           #19.2
..___tag_value_main.8:
...
..B1.16:                        # Preds ..B1.15
                                # Execution count [1.00e+00]
        movl      $.L_2__STRING.10, %edi                        #19.2
        movl      $.L_2__STRING.11, %esi                        #19.2
...
..B1.17:                        # Preds ..B1.16
        ...
        movl      $64, %ecx                                     #19.2
        movq      %rax, %rdi                                    #19.2
        movq      %rax, fileForSpeedups(%rip)                   #19.2
        movl      $.L_2__STRING.12, %esi                        #19.2
        movl      %ecx, %r8d                                    #19.2
        xorl      %eax, %eax                                    #19.2
        movq      programName(%rip), %rdx                       #19.2
        movq      ttbest_rdtsc(%rip), %r9                       #19.2
...
..L17:
	...
	.cfi_offset 6, -16
        ...
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm5             #71.67
        vmovsd    .L_2il0floatpacket.5(%rip), %xmm4             #71.58
        vmovdqu   .L_2il0floatpacket.2(%rip), %ymm3             #71.4
        vmovdqu   .L_2il0floatpacket.3(%rip), %ymm2             #71.32
        vmovupd   .L_2il0floatpacket.7(%rip), %ymm14            #71.46
        vmovupd   .L_2il0floatpacket.8(%rip), %ymm8             #71.37
...
..B3.4:                         # Preds ..B3.3
        ...
        vmovsd    .L_2il0floatpacket.5(%rip), %xmm4             #
...
..___tag_value_assignMatrixf32.49:
        vmovupd   .L_2il0floatpacket.13(%rip), %ymm3            #84.35
        ...
        vpand     .L_2il0floatpacket.9(%rip), %ymm4, %ymm6      #84.35
        ...
        vpmulld   .L_2il0floatpacket.14(%rip), %ymm8, %ymm8     #84.35
...
..___tag_value_assignMatrixf32.52:
        ...
        vpmuldq   %ymm3, %ymm2, %ymm4                           #84.35
        vpsrlq    $32, %ymm8, %ymm5                             #84.35
        vpand     .L_2il0floatpacket.9(%rip), %ymm4, %ymm1      #84.35
...
..___tag_value_assignMatrixf32.58:
        ...
        vpsrlq    $32, %ymm8, %ymm5                             #84.35
        vpand     .L_2il0floatpacket.9(%rip), %ymm1, %ymm6      #84.35
...
..___tag_value_assignMatrixf32.61:
        vmovupd   .L_2il0floatpacket.13(%rip), %ymm1            #84.35
...
..___tag_value_assignMatrixf32.65:
        ...
        vpmulld   .L_2il0floatpacket.14(%rip), %ymm2, %ymm2     #84.35
...
..___tag_value_assignMatrixf32.69:
        vmovupd   .L_2il0floatpacket.13(%rip), %ymm8            #84.35
        ...
        vpand     .L_2il0floatpacket.9(%rip), %ymm1, %ymm4      #84.35
        vpor      %ymm4, %ymm3, %ymm5                           #84.35
        vpsrad    $6, %ymm5, %ymm6                              #84.35
        vpsubd    %ymm7, %ymm6, %ymm9                           #84.35
        vpmulld   .L_2il0floatpacket.14(%rip), %ymm9, %ymm15    #84.35
...
..___tag_value_assignImagei32.90:
        ...
        vpand     .L_2il0floatpacket.9(%rip), %ymm8, %ymm6      #96.4
...
..___tag_value_assignImagei32.93:
        ...
        vpand     .L_2il0floatpacket.9(%rip), %ymm2, %ymm4      #96.4
...
..___tag_value_assignImagei32.96:
        ...
        vpand     .L_2il0floatpacket.9(%rip), %ymm4, %ymm1      #96.4
...
..___tag_value_assignImagei32.99:
        ...
        vpand     .L_2il0floatpacket.9(%rip), %ymm4, %ymm6      #96.4
...
..___tag_value_assignImagei32.102:
        ...
        vpsrlq    $32, %ymm8, %ymm5                             #96.4
        vpand     .L_2il0floatpacket.9(%rip), %ymm1, %ymm6      #96.4
...
..___tag_value_assignImagei32.112:
        ...
        vpand     .L_2il0floatpacket.9(%rip), %ymm1, %ymm4      #96.4
...
..L119:
        ...
        vmovupd   .L_2il0floatpacket.13(%rip), %ymm1            #110.4
...
..B6.2:                         # Preds ..B6.2 ..B6.1
        ...
        vpmuldq   %ymm1, %ymm10, %ymm12                         #110.4
        vpsrlq    $32, %ymm11, %ymm13                           #110.4
        vpand     .L_2il0floatpacket.9(%rip), %ymm12, %ymm15    #110.4
        vpsrad    $31, %ymm14, %ymm12                           #110.4
        vpor      %ymm15, %ymm13, %ymm10                        #110.4
        vpsrad    $6, %ymm10, %ymm11                            #110.4
        vpsubd    %ymm12, %ymm11, %ymm13                        #110.4
        vpmulld   .L_2il0floatpacket.14(%rip), %ymm13, %ymm15   #110.4
...
..B12.6:                        # Preds ..B12.4 ..B12.1
        ...
        vmovupd   .L_2il0floatpacket.13(%rip), %ymm2            #184.4
        movl      %r8d, %r8d                                    #180.3
...
..B12.7:                        # Preds ..B12.7 ..B12.6
        ...
        vpand     .L_2il0floatpacket.9(%rip), %ymm6, %ymm8      #184.4
        vpor      %ymm8, %ymm7, %ymm9                           #184.4
        vpsrad    $6, %ymm9, %ymm10                             #184.4
        vpsubd    %ymm11, %ymm10, %ymm12                        #184.4
        vpmulld   .L_2il0floatpacket.14(%rip), %ymm12, %ymm14   #184.4
