...
# mark_description "-D _GNU_SOURCE -O3 -xHOST -no-vec -S -c -o TRA2icc.s";
	.file "TRA2.c"
	.text
..TXTST0:
...
..B1.28:                        # Preds ..B1.1
                                # Execution count [1.00e+00]
        vstmxcsr  (%rsp)                                        #13.1
        vpxor     %ymm0, %ymm0, %ymm0                           #14.2
        orl       $32832, (%rsp)                                #13.1
        vldmxcsr  (%rsp)                                        #13.1
        vmovdqu   %ymm0, mask(%rip)                             #14.2
        vmovdqu   %ymm0, 32+mask(%rip)                          #14.2
        vmovdqu   %ymm0, 64+mask(%rip)                          #14.2
        vmovdqu   %ymm0, 96+mask(%rip)                          #14.2
                                # LOE rbx r12 r13 r14 r15
..B1.2:                         # Preds ..B1.28
...
..B1.7:                         # Preds ..B1.6
        ...
        movq      $0x4a817c7ff, %rax                            #23.2
        movq      $.L_2__STRING.8, programName(%rip)            #20.6
        movq      $9999999, elapsed_rdtsc(%rip)                 #23.2
        movq      %rax, overal_time(%rip)                       #23.2
        movq      $0, ttime(%rip)                               #23.2
                                # LOE rbx r12 r13 r14 r15
...
..B1.11:                        # Preds ..B1.11 ..B1.10
        ...
        vmovdqu   t(%rax,%rsi,4), %xmm0                         #30.38
        vmovdqu   256+t(%rax,%rsi,4), %xmm1                     #31.38
        vmovdqu   512+t(%rax,%rsi,4), %xmm2                     #32.38
        vmovdqu   768+t(%rax,%rsi,4), %xmm3                     #33.38
        addq      $4, %rsi                                      #28.18
        vpunpckldq %xmm1, %xmm0, %xmm4                          #35.11
        vpunpckldq %xmm3, %xmm2, %xmm5                          #36.11
        vpunpckhdq %xmm1, %xmm0, %xmm6                          #37.11
        vpunpckhdq %xmm3, %xmm2, %xmm7                          #38.11
        vpunpcklqdq %xmm5, %xmm4, %xmm8                         #41.11
        vpunpckhqdq %xmm5, %xmm4, %xmm9                         #42.11
        vpunpcklqdq %xmm7, %xmm6, %xmm10                        #43.11
        vpunpckhqdq %xmm7, %xmm6, %xmm11                        #44.11
        vmovdqu   %xmm8, c_tra(%rcx)                            #46.32
        vmovdqu   %xmm9, 256+c_tra(%rcx)                        #47.32
        vmovdqu   %xmm10, 512+c_tra(%rcx)                       #48.32
        vmovdqu   %xmm11, 768+c_tra(%rcx)                       #49.32
        addq      $1024, %rcx                                   #28.18
        cmpq      $64, %rsi                                     #28.13
        jl        ..B1.11       # Prob 93%                      #28.13
                                # LOE rax rdx rcx rbx rsi r12 r13 r14 r15
..B1.12:                        # Preds ..B1.11
                                # Execution count [4.65e+01]
        addq      $4, %rdx                                      #27.18
...
..B1.32:                        # Preds ..B1.33
                                # Execution count [2.91e+00]
        movq      t2_rdtsc(%rip), %rdx                          #57.3
        subq      t1_rdtsc(%rip), %rdx                          #57.3
        movq      ttbest_rdtsc(%rip), %rsi                      #57.3
        movq      %rdx, ttotal_rdtsc(%rip)                      #57.3
        cmpq      %rsi, %rdx                                    #57.3
        jge       ..B1.16       # Prob 50%                      #57.3
                                # LOE rdx rbx rsi r12 r13 r14 r15
..B1.15:                        # Preds ..B1.32
                                # Execution count [1.45e+00]
        movq      elapsed_rdtsc(%rip), %rcx                     #57.3
        movq      %rcx, %rax                                    #57.3
        negq      %rax                                          #57.3
        movq      %rdx, %rsi                                    #57.3
        addq      $9999999, %rax                                #57.3
        movq      %rdx, ttbest_rdtsc(%rip)                      #57.3
        movq      %rax, elapsed(%rip)                           #57.3
        jmp       ..B1.17       # Prob 100%                     #57.3
...
..B1.17:                        # Preds ..B1.15 ..B1.16
                                # Execution count [2.91e+00]
        movq      ttime(%rip), %rax                             #57.3
        addq      %rdx, %rax                                    #57.3
        movq      %rax, ttime(%rip)                             #57.3
        testq     %rcx, %rcx                                    #57.3
        je        ..B1.20       # Prob 50%                      #57.3
                                # LOE rax rcx rbx rsi r12 r13 r14 r15
..B1.18:                        # Preds ..B1.17
                                # Execution count [1.45e+00]
        decq      %rcx                                          #57.3
        movq      %rcx, elapsed_rdtsc(%rip)                     #57.3
        cmpq      overal_time(%rip), %rax                       #57.3
        jl        ..B1.8        # Prob 82%                      #57.3
        jmp       ..B1.21       # Prob 100%                     #57.3
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.20:                        # Preds ..B1.17
                                # Execution count [1.45e+00]
        movq      $-1, elapsed_rdtsc(%rip)                      #57.3
        movq      $-1, %rcx                                     #57.3
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.21:                        # Preds ..B1.18 ..B1.20
                                # Execution count [1.00e+00]
        negq      %rcx                                          #57.3
        movl      $.L_2__STRING.9, %edi                         #57.3
        addq      $9999999, %rcx                                #57.3
        xorl      %eax, %eax                                    #57.3
        movq      elapsed(%rip), %rdx                           #57.3
..___tag_value_main.8:
...
..B1.22:                        # Preds ..B1.21
                                # Execution count [1.00e+00]
        movl      $.L_2__STRING.10, %edi                        #57.3
        movl      $.L_2__STRING.11, %esi                        #57.3
...
..B1.23:                        # Preds ..B1.22
        ...
        movl      $64, %ecx                                     #57.3
        movq      %rax, %rdi                                    #57.3
        movq      %rax, fileForSpeedups(%rip)                   #57.3
        movl      $.L_2__STRING.12, %esi                        #57.3
        movl      %ecx, %r8d                                    #57.3
        xorl      %eax, %eax                                    #57.3
        movq      programName(%rip), %rdx                       #57.3
        movq      ttbest_rdtsc(%rip), %r9                       #57.3
#       fprintf(FILE *__restrict__, const char *__restrict__, ...)
        call      fprintf                                       #57.3
                                # LOE rbx r12 r13 r14 r15
..B1.24:                        # Preds ..B1.23
                                # Execution count [1.00e+00]
        movl      $.L_2__STRING.13, %edi                        #58.5
        xorl      %eax, %eax                                    #58.5
        movl      8320+c_tra(%rip), %esi                        #58.5
