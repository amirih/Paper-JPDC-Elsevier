...
# mark_description "-D _GNU_SOURCE -O3 -xHOST -no-vec -S -c -o TRA3Gicc.s";
	.file "TRA3G.c"
	.text
..TXTST0:
...
..B1.5:                         # Preds ..B1.5 ..B1.4
        ...
        movl      %ecx, %r10d                                   #14.2
        movl      $274877907, %eax                              #14.2
        imull     %r8d, %r10d                                   #14.2
        incl      %r8d                                          #14.2
        imull     %r10d                                         #14.2
        sarl      $6, %edx                                      #14.2
        imull     $-1000, %edx, %r9d                            #14.2
        addl      %r9d, %r10d                                   #14.2
        movl      %r10d, A(%rdi)                                #14.2
        addq      $4, %rdi                                      #14.2
        cmpl      $64, %r8d                                     #14.2
        jl        ..B1.5        # Prob 98%                      #14.2
                                # LOE rbx rsi rdi r12 r13 r14 r15 ecx r8d
..B1.6:                         # Preds ..B1.5
                                # Execution count [6.40e+01]
        incl      %ecx                                          #14.2
        addq      $256, %rsi                                    #14.2
        cmpl      $64, %ecx                                     #14.2
        jl        ..B1.4        # Prob 98%                      #14.2
                                # LOE rbx rsi r12 r13 r14 r15 ecx
..B1.7:                         # Preds ..B1.6
                                # Execution count [1.00e+00]
        vmovups   vindexm.379.0.0.16(%rip), %ymm1               #17.18
                                # LOE rbx r12 r13 r14 r15 ymm1
..B1.8:                         # Preds ..B1.7
                                # Execution count [1.72e+00]
        movq      $0x4a817c7ff, %rax                            #23.3
        movq      $.L_2__STRING.8, programName(%rip)            #20.7
        movq      $9999999, elapsed_rdtsc(%rip)                 #23.3
        movq      %rax, overal_time(%rip)                       #23.3
        movq      $0, ttime(%rip)                               #23.3
        vpcmpeqd  %ymm0, %ymm0, %ymm0                           #30.12
                                # LOE rbx r12 r13 r14 r15
...
..B1.10:                        # Preds ..B1.31
                                # Execution count [2.91e+00]
        xorl      %edx, %edx                                    #26.6
        movq      %rax, t1_rdtsc(%rip)                          #23.3
        xorl      %eax, %eax                                    #26.6
        vpcmpeqd  %ymm1, %ymm1, %ymm1                           #26.6
        vmovups   vindexm.379.0.0.16(%rip), %ymm3               #26.6
...
..B1.12:                        # Preds ..B1.12 ..B1.11
        ...
        vmovdqa   %ymm1, %ymm4                                  #30.12
        lea       (%rax,%rsi,4), %rdi                           #30.50
        vpxor     %ymm2, %ymm2, %ymm2                           #30.12
        addq      $8, %rsi                                      #27.22
        vpxor     %ymm0, %ymm0, %ymm0                           #31.12
        vpxor     %ymm12, %ymm12, %ymm12                        #32.12
        vpxor     %ymm13, %ymm13, %ymm13                        #33.12
        vpxor     %ymm14, %ymm14, %ymm14                        #34.12
        vpxor     %ymm15, %ymm15, %ymm15                        #35.12
        vpgatherdd %ymm4, A(%rdi,%ymm3,4), %ymm2                #30.12
        vpxor     %ymm4, %ymm4, %ymm4                           #36.12
        vmovdqu   %ymm2, A_T(%rcx)                              #40.36
        vmovdqa   %ymm1, %ymm5                                  #31.12
        vpgatherdd %ymm5, 4+A(%rdi,%ymm3,4), %ymm0              #31.12
        vpxor     %ymm5, %ymm5, %ymm5                           #37.12
        vmovdqu   %ymm0, 256+A_T(%rcx)                          #41.36
        vmovdqa   %ymm1, %ymm6                                  #32.12
        vmovdqa   %ymm1, %ymm7                                  #33.12
        vmovdqa   %ymm1, %ymm8                                  #34.12
        vmovdqa   %ymm1, %ymm9                                  #35.12
        vmovdqa   %ymm1, %ymm10                                 #36.12
        vmovdqa   %ymm1, %ymm11                                 #37.12
        vpgatherdd %ymm6, 8+A(%rdi,%ymm3,4), %ymm12             #32.12
        vpgatherdd %ymm7, 12+A(%rdi,%ymm3,4), %ymm13            #33.12
        vpgatherdd %ymm8, 16+A(%rdi,%ymm3,4), %ymm14            #34.12
        vpgatherdd %ymm9, 20+A(%rdi,%ymm3,4), %ymm15            #35.12
        vpgatherdd %ymm10, 24+A(%rdi,%ymm3,4), %ymm4            #36.12
        vpgatherdd %ymm11, 28+A(%rdi,%ymm3,4), %ymm5            #37.12
        vmovdqu   %ymm12, 512+A_T(%rcx)                         #42.36
        vmovdqu   %ymm13, 768+A_T(%rcx)                         #43.36
        vmovdqu   %ymm14, 1024+A_T(%rcx)                        #44.36
        vmovdqu   %ymm15, 1280+A_T(%rcx)                        #45.36
        vmovdqu   %ymm4, 1536+A_T(%rcx)                         #46.36
        vmovdqu   %ymm5, 1792+A_T(%rcx)                         #47.36
        addq      $2048, %rcx                                   #27.22
        cmpq      $64, %rsi                                     #27.15
        jl        ..B1.12       # Prob 87%                      #27.15
                                # LOE rax rdx rcx rbx rsi r12 r13 r14 r15 ymm1 ymm3
..B1.13:                        # Preds ..B1.12
                                # Execution count [2.33e+01]
        addq      $8, %rdx                                      #26.20
...
..B1.19:                        # Preds ..B1.18
        ...
        jl        ..B1.9        # Prob 82%                      #53.3
        jmp       ..B1.22       # Prob 100%                     #53.3
...
..B1.25:                        # Preds ..B1.24
                                # Execution count [1.00e+00]
        movl      $.L_2__STRING.13, %edi                        #54.5
        xorl      %eax, %eax                                    #54.5
        movl      8320+A_T(%rip), %esi                          #54.5
