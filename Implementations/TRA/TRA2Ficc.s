...
# mark_description "-D _GNU_SOURCE -Ofast -march=native -no-vec -S -c -o TRA2Ficc.s";
	.file "TRA2F.c"
	.text
..TXTST0:
...
..B1.3:                         # Preds ..B1.2
                                # Execution count [1.00e+00]
        movq      $.L_2__STRING.8, programName(%rip)            #13.2
        xorl      %r9d, %r9d                                    #14.2
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm0             #14.2
        xorl      %ecx, %ecx                                    #14.2
...
..B1.5:                         # Preds ..B1.5 ..B1.4
        ...
        sarl      $31, %r11d                                    #14.2
        subl      %r11d, %edx                                   #14.2
        imull     $-1000, %edx, %eax                            #14.2
        addl      %eax, %esi                                    #14.2
        vcvtsi2sd %esi, %xmm1, %xmm1                            #14.2
        vaddsd    %xmm1, %xmm0, %xmm2                           #14.2
        vcvtsd2ss %xmm2, %xmm2, %xmm2                           #14.2
        vmovss    %xmm2, t(%r8)                                 #14.2
        addq      $4, %r8                                       #14.2
        cmpl      $64, %edi                                     #14.2
...
..B1.7:                         # Preds ..B1.6
        ...
        movq      $0x4a817c7ff, %rax                            #16.2
        movq      $9999999, elapsed_rdtsc(%rip)                 #16.2
        movq      %rax, overal_time(%rip)                       #16.2
        movq      $0, ttime(%rip)                               #16.2
                                # LOE rbx r12 r13 r14 r15
...
..B1.9:                         # Preds ..B1.30
                                # Execution count [2.91e+00]
        xorl      %edx, %edx                                    #18.8
        movq      %rax, t1_rdtsc(%rip)                          #16.2
        xorl      %eax, %eax                                    #18.8
                                # LOE rax rdx rbx r12 r13 r14 r15
..B1.10:                        # Preds ..B1.12 ..B1.9
                                # Execution count [4.65e+01]
        xorl      %esi, %esi                                    #19.9
        lea       (,%rdx,4), %rcx                               #27.18
        .align    16,0x90
                                # LOE rax rdx rcx rbx rsi r12 r13 r14 r15
..B1.11:                        # Preds ..B1.11 ..B1.10
                                # Execution count [7.44e+02]
        vmovups   t(%rax,%rsi,4), %xmm0                         #20.24
        vmovups   256+t(%rax,%rsi,4), %xmm1                     #21.24
        vmovups   512+t(%rax,%rsi,4), %xmm2                     #22.24
        vmovups   768+t(%rax,%rsi,4), %xmm3                     #23.24
        addq      $4, %rsi                                      #19.20
        vunpcklps %xmm1, %xmm0, %xmm5                           #25.4
        vunpcklps %xmm3, %xmm2, %xmm4                           #25.4
        vunpckhps %xmm1, %xmm0, %xmm7                           #25.4
        vunpckhps %xmm3, %xmm2, %xmm6                           #25.4
        vmovlhps  %xmm4, %xmm5, %xmm8                           #25.4
        vmovhlps  %xmm5, %xmm4, %xmm9                           #25.4
        vmovlhps  %xmm6, %xmm7, %xmm10                          #25.4
        vmovhlps  %xmm7, %xmm6, %xmm11                          #25.4
        vmovups   %xmm8, c_tra(%rcx)                            #27.18
        vmovups   %xmm9, 256+c_tra(%rcx)                        #28.18
        vmovups   %xmm10, 512+c_tra(%rcx)                       #29.18
        vmovups   %xmm11, 768+c_tra(%rcx)                       #30.18
        addq      $1024, %rcx                                   #19.20
        cmpq      $64, %rsi                                     #19.15
        jl        ..B1.11       # Prob 93%                      #19.15
                                # LOE rax rdx rcx rbx rsi r12 r13 r14 r15
..B1.12:                        # Preds ..B1.11
                                # Execution count [4.65e+01]
        addq      $4, %rdx                                      #18.19
...
..B1.32:                        # Preds ..B1.33
                                # Execution count [2.91e+00]
        movq      t2_rdtsc(%rip), %rdx                          #34.3
        subq      t1_rdtsc(%rip), %rdx                          #34.3
        movq      ttbest_rdtsc(%rip), %rsi                      #34.3
        movq      %rdx, ttotal_rdtsc(%rip)                      #34.3
        cmpq      %rsi, %rdx                                    #34.3
        jge       ..B1.16       # Prob 50%                      #34.3
                                # LOE rdx rbx rsi r12 r13 r14 r15
..B1.15:                        # Preds ..B1.32
                                # Execution count [1.45e+00]
        movq      elapsed_rdtsc(%rip), %rcx                     #34.3
        movq      %rcx, %rax                                    #34.3
        negq      %rax                                          #34.3
        movq      %rdx, %rsi                                    #34.3
        addq      $9999999, %rax                                #34.3
        movq      %rdx, ttbest_rdtsc(%rip)                      #34.3
        movq      %rax, elapsed(%rip)                           #34.3
        jmp       ..B1.17       # Prob 100%                     #34.3
...
..B1.17:                        # Preds ..B1.15 ..B1.16
                                # Execution count [2.91e+00]
        movq      ttime(%rip), %rax                             #34.3
        addq      %rdx, %rax                                    #34.3
        movq      %rax, ttime(%rip)                             #34.3
        testq     %rcx, %rcx                                    #34.3
        je        ..B1.20       # Prob 50%                      #34.3
                                # LOE rax rcx rbx rsi r12 r13 r14 r15
..B1.18:                        # Preds ..B1.17
                                # Execution count [1.45e+00]
        decq      %rcx                                          #34.3
        movq      %rcx, elapsed_rdtsc(%rip)                     #34.3
        cmpq      overal_time(%rip), %rax                       #34.3
        jl        ..B1.8        # Prob 82%                      #34.3
        jmp       ..B1.21       # Prob 100%                     #34.3
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.20:                        # Preds ..B1.17
                                # Execution count [1.45e+00]
        movq      $-1, elapsed_rdtsc(%rip)                      #34.3
        movq      $-1, %rcx                                     #34.3
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.21:                        # Preds ..B1.18 ..B1.20
                                # Execution count [1.00e+00]
        negq      %rcx                                          #34.3
        movl      $.L_2__STRING.9, %edi                         #34.3
        addq      $9999999, %rcx                                #34.3
        xorl      %eax, %eax                                    #34.3
        movq      elapsed(%rip), %rdx                           #34.3
..___tag_value_main.8:
...
..B1.22:                        # Preds ..B1.21
                                # Execution count [1.00e+00]
        movl      $.L_2__STRING.10, %edi                        #34.3
        movl      $.L_2__STRING.11, %esi                        #34.3
...
..B1.23:                        # Preds ..B1.22
        ...
        movl      $64, %ecx                                     #34.3
        movq      %rax, %rdi                                    #34.3
        movq      %rax, fileForSpeedups(%rip)                   #34.3
        movl      $.L_2__STRING.12, %esi                        #34.3
        movl      %ecx, %r8d                                    #34.3
        xorl      %eax, %eax                                    #34.3
        movq      programName(%rip), %rdx                       #34.3
        movq      ttbest_rdtsc(%rip), %r9                       #34.3
#       fprintf(FILE *__restrict__, const char *__restrict__, ...)
        call      fprintf                                       #34.3
                                # LOE rbx r12 r13 r14 r15
..B1.24:                        # Preds ..B1.23
                                # Execution count [1.00e+00]
        vxorpd    %xmm0, %xmm0, %xmm0                           #35.5
        movl      $.L_2__STRING.13, %edi                        #35.5
        movl      $1, %eax                                      #35.5
        vcvtss2sd 8320+c_tra(%rip), %xmm0, %xmm0                #35.5
