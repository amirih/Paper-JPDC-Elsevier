...
.L97:
	...
	.p2align 3
.L98:
	vpermq	$216, 256(%rdx), %ymm0
	vpermq	$216, (%rdx), %ymm7
	vpermq	$216, 512(%rdx), %ymm1
	vpunpckldq	%ymm0, %ymm7, %ymm8
	vpunpckhdq	%ymm0, %ymm7, %ymm7
	vpermq	$216, 768(%rdx), %ymm0
	vpermq	$216, 1024(%rdx), %ymm4
	vpunpckldq	%ymm0, %ymm1, %ymm3
	vpunpckhdq	%ymm0, %ymm1, %ymm0
	vpermq	$216, 1280(%rdx), %ymm1
	vpermq	$216, 1536(%rdx), %ymm5
	vpunpckldq	%ymm1, %ymm4, %ymm2
	vpunpckhdq	%ymm1, %ymm4, %ymm1
	vpermq	$216, 1792(%rdx), %ymm4
