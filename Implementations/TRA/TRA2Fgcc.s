...
.L97:
	...
	.p2align 3
.L98:
	vmovaps	256(%rdx), %xmm5
	vmovaps	768(%rdx), %xmm4
	vmovaps	(%rdx), %xmm0
	vmovaps	512(%rdx), %xmm1
	vunpcklps	%xmm5, %xmm0, %xmm2
	vunpcklps	%xmm4, %xmm1, %xmm3
	vunpckhps	%xmm5, %xmm0, %xmm0
	vunpckhps	%xmm4, %xmm1, %xmm1
	vmovhlps	%xmm2, %xmm3, %xmm7
	vmovaps	%xmm7, 256(%rax)
	vmovlhps	%xmm3, %xmm2, %xmm5
	vmovlhps	%xmm1, %xmm0, %xmm4
	vmovhlps	%xmm0, %xmm1, %xmm7
	vmovaps	%xmm5, (%rax)
	vmovaps	%xmm4, 512(%rax)
	vmovaps	%xmm7, 768(%rax)
	addq	$1024, %rax
	addq	$16, %rdx
	cmpq	%rax, %rcx
	jne	.L98
...
.L102:
	...
	movl	$.LC15, %edi
	movl	$1, %eax
	vcvtss2sd	c_tra+8320(%rip), %xmm6, %xmm0
	call	printf
	xorl	%eax, %eax
	addq	$8, %rsp
	.cfi_remember_state
