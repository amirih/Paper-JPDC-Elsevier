...
# mark_description "-D _GNU_SOURCE -Ofast -march=native -no-vec -S -c -o TRA3FSicc.s";
	.file "TRA3FS.c"
	.text
..TXTST0:
...
..B1.28:                        # Preds ..B1.1
                                # Execution count [1.00e+00]
        vstmxcsr  (%rsp)                                        #13.1
        vpxor     %ymm0, %ymm0, %ymm0                           #16.2
        orl       $32832, (%rsp)                                #13.1
        vldmxcsr  (%rsp)                                        #13.1
        movq      $.L_2__STRING.8, programName(%rip)            #14.2
        vmovdqu   %ymm0, mask(%rip)                             #16.2
        vmovdqu   %ymm0, 32+mask(%rip)                          #16.2
        vmovdqu   %ymm0, 64+mask(%rip)                          #16.2
        vmovdqu   %ymm0, 96+mask(%rip)                          #16.2
                                # LOE rbx r12 r13 r14 r15
..B1.2:                         # Preds ..B1.28
        ...
        movl      $128, %esi                                    #16.2
        movl      $mask, %edx                                   #16.2
        orq       $12, mask(%rip)                               #16.2
        vzeroupper                                              #16.2
..___tag_value_main.6:
#       sched_setaffinity(__pid_t, size_t, const cpu_set_t *)
        call      sched_setaffinity                             #16.2
..___tag_value_main.7:
                                # LOE rbx r12 r13 r14 r15
..B1.3:                         # Preds ..B1.2
                                # Execution count [1.00e+00]
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm0             #17.2
        xorl      %r9d, %r9d                                    #17.2
        xorl      %ecx, %ecx                                    #17.2
...
..B1.5:                         # Preds ..B1.5 ..B1.4
        ...
        movl      %r9d, %eax                                    #17.2
        xorl      %edx, %edx                                    #17.2
        vxorpd    %xmm1, %xmm1, %xmm1                           #17.2
        idivl     %edi                                          #17.2
        movl      %eax, %esi                                    #17.2
        movl      $274877907, %eax                              #17.2
        addl      %r10d, %esi                                   #17.2
        addl      %r9d, %r10d                                   #17.2
        imull     %esi                                          #17.2
        movl      %esi, %r11d                                   #17.2
        ...
        sarl      $31, %r11d                                    #17.2
        subl      %r11d, %edx                                   #17.2
        imull     $-1000, %edx, %eax                            #17.2
        addl      %eax, %esi                                    #17.2
        vcvtsi2sd %esi, %xmm1, %xmm1                            #17.2
        vaddsd    %xmm1, %xmm0, %xmm2                           #17.2
        vcvtsd2ss %xmm2, %xmm2, %xmm2                           #17.2
        vmovss    %xmm2, t(%r8)                                 #17.2
        addq      $4, %r8                                       #17.2
        cmpl      $64, %edi                                     #17.2
        jl        ..B1.5        # Prob 98%                      #17.2
                                # LOE rcx rbx r8 r12 r13 r14 r15 edi r9d r10d xmm0
..B1.6:                         # Preds ..B1.5
                                # Execution count [6.40e+01]
        incl      %r9d                                          #17.2
...
..B1.11:                        # Preds ..B1.11 ..B1.10
        ...
        vmovups   t(%rax,%rsi,4), %ymm8                         #28.28
        vmovups   256+t(%rax,%rsi,4), %ymm9                     #29.28
        vmovups   512+t(%rax,%rsi,4), %ymm10                    #30.28
        vmovups   768+t(%rax,%rsi,4), %ymm11                    #31.28
        vmovups   1024+t(%rax,%rsi,4), %ymm12                   #32.28
        vmovups   1280+t(%rax,%rsi,4), %ymm13                   #33.28
        vmovups   1536+t(%rax,%rsi,4), %ymm14                   #34.28
        vmovups   1792+t(%rax,%rsi,4), %ymm15                   #35.28
        vunpcklps %ymm9, %ymm8, %ymm6                           #37.11
        addq      $8, %rsi                                      #26.19
        vunpckhps %ymm9, %ymm8, %ymm7                           #38.11
        vunpcklps %ymm11, %ymm10, %ymm0                         #39.11
        vunpckhps %ymm11, %ymm10, %ymm8                         #40.11
        vunpcklps %ymm13, %ymm12, %ymm5                         #41.11
        vunpckhps %ymm13, %ymm12, %ymm4                         #42.11
        vunpcklps %ymm15, %ymm14, %ymm9                         #43.11
        vunpckhps %ymm15, %ymm14, %ymm10                        #44.11
        vshufps   $68, %ymm0, %ymm6, %ymm3                      #47.12
        vshufps   $238, %ymm0, %ymm6, %ymm1                     #48.12
        vshufps   $68, %ymm8, %ymm7, %ymm2                      #49.12
        vshufps   $238, %ymm8, %ymm7, %ymm0                     #50.12
        vshufps   $68, %ymm9, %ymm5, %ymm6                      #51.12
        vshufps   $238, %ymm9, %ymm5, %ymm5                     #52.12
        vshufps   $68, %ymm10, %ymm4, %ymm7                     #53.12
        vshufps   $238, %ymm10, %ymm4, %ymm4                    #54.12
        vperm2f128 $32, %ymm6, %ymm3, %ymm11                    #57.11
        vperm2f128 $32, %ymm5, %ymm1, %ymm12                    #60.11
        vperm2f128 $32, %ymm7, %ymm2, %ymm13                    #61.11
        vperm2f128 $32, %ymm4, %ymm0, %ymm14                    #62.11
        vperm2f128 $49, %ymm6, %ymm3, %ymm3                     #63.11
        vperm2f128 $49, %ymm5, %ymm1, %ymm1                     #64.11
        vperm2f128 $49, %ymm7, %ymm2, %ymm2                     #65.11
        vperm2f128 $49, %ymm4, %ymm0, %ymm15                    #66.11
        vmovups   %ymm11, c_tra(%rcx)                           #68.22
        vmovups   %ymm12, 256+c_tra(%rcx)                       #69.22
        vmovups   %ymm13, 512+c_tra(%rcx)                       #70.22
        vmovups   %ymm14, 768+c_tra(%rcx)                       #71.22
        vmovups   %ymm3, 1024+c_tra(%rcx)                       #72.22
        vmovups   %ymm1, 1280+c_tra(%rcx)                       #73.22
        vmovups   %ymm2, 1536+c_tra(%rcx)                       #74.22
        vmovups   %ymm15, 1792+c_tra(%rcx)                      #75.22
        addq      $2048, %rcx                                   #26.19
        cmpq      $64, %rsi                                     #26.14
        jl        ..B1.11       # Prob 87%                      #26.14
                                # LOE rax rdx rcx rbx rsi r12 r13 r14 r15
..B1.12:                        # Preds ..B1.11
                                # Execution count [2.33e+01]
        addq      $8, %rdx                                      #25.19
...
..B1.32:                        # Preds ..B1.33
                                # Execution count [2.91e+00]
        movq      t2_rdtsc(%rip), %rdx                          #80.2
        subq      t1_rdtsc(%rip), %rdx                          #80.2
        movq      ttbest_rdtsc(%rip), %rsi                      #80.2
        movq      %rdx, ttotal_rdtsc(%rip)                      #80.2
        cmpq      %rsi, %rdx                                    #80.2
        jge       ..B1.16       # Prob 50%                      #80.2
                                # LOE rdx rbx rsi r12 r13 r14 r15
..B1.15:                        # Preds ..B1.32
                                # Execution count [1.45e+00]
        movq      elapsed_rdtsc(%rip), %rcx                     #80.2
        movq      %rcx, %rax                                    #80.2
        negq      %rax                                          #80.2
        movq      %rdx, %rsi                                    #80.2
        addq      $9999999, %rax                                #80.2
        movq      %rdx, ttbest_rdtsc(%rip)                      #80.2
        movq      %rax, elapsed(%rip)                           #80.2
        jmp       ..B1.17       # Prob 100%                     #80.2
...
..B1.17:                        # Preds ..B1.15 ..B1.16
                                # Execution count [2.91e+00]
        movq      ttime(%rip), %rax                             #80.2
        addq      %rdx, %rax                                    #80.2
        movq      %rax, ttime(%rip)                             #80.2
        testq     %rcx, %rcx                                    #80.2
        je        ..B1.20       # Prob 50%                      #80.2
                                # LOE rax rcx rbx rsi r12 r13 r14 r15
..B1.18:                        # Preds ..B1.17
                                # Execution count [1.45e+00]
        decq      %rcx                                          #80.2
        movq      %rcx, elapsed_rdtsc(%rip)                     #80.2
        cmpq      overal_time(%rip), %rax                       #80.2
        jl        ..B1.8        # Prob 82%                      #80.2
        jmp       ..B1.21       # Prob 100%                     #80.2
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.20:                        # Preds ..B1.17
                                # Execution count [1.45e+00]
        movq      $-1, elapsed_rdtsc(%rip)                      #80.2
        movq      $-1, %rcx                                     #80.2
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.21:                        # Preds ..B1.18 ..B1.20
                                # Execution count [1.00e+00]
        negq      %rcx                                          #80.2
        movl      $.L_2__STRING.9, %edi                         #80.2
        addq      $9999999, %rcx                                #80.2
        xorl      %eax, %eax                                    #80.2
        movq      elapsed(%rip), %rdx                           #80.2
..___tag_value_main.8:
...
..B1.22:                        # Preds ..B1.21
                                # Execution count [1.00e+00]
        movl      $.L_2__STRING.10, %edi                        #80.2
        movl      $.L_2__STRING.11, %esi                        #80.2
...
..B1.23:                        # Preds ..B1.22
        ...
        movl      $64, %ecx                                     #80.2
        movq      %rax, %rdi                                    #80.2
        movq      %rax, fileForSpeedups(%rip)                   #80.2
        movl      $.L_2__STRING.12, %esi                        #80.2
        movl      %ecx, %r8d                                    #80.2
        xorl      %eax, %eax                                    #80.2
        movq      programName(%rip), %rdx                       #80.2
        movq      ttbest_rdtsc(%rip), %r9                       #80.2
#       fprintf(FILE *__restrict__, const char *__restrict__, ...)
        call      fprintf                                       #80.2
                                # LOE rbx r12 r13 r14 r15
..B1.24:                        # Preds ..B1.23
                                # Execution count [1.00e+00]
        vxorpd    %xmm0, %xmm0, %xmm0                           #81.4
        movl      $.L_2__STRING.13, %edi                        #81.4
        movl      $1, %eax                                      #81.4
        vcvtss2sd 8320+c_tra(%rip), %xmm0, %xmm0                #81.4
