...
# mark_description "-D _GNU_SOURCE -O3 -xHOST -no-vec -S -c -o TRA3Sicc.s";
	.file "TRA3S.c"
	.text
..TXTST0:
...
..B1.27:                        # Preds ..B1.1
                                # Execution count [1.00e+00]
        vstmxcsr  (%rsp)                                        #11.1
        vpxor     %ymm0, %ymm0, %ymm0                           #12.2
        orl       $32832, (%rsp)                                #11.1
        vldmxcsr  (%rsp)                                        #11.1
        vmovdqu   %ymm0, mask(%rip)                             #12.2
        vmovdqu   %ymm0, 32+mask(%rip)                          #12.2
        vmovdqu   %ymm0, 64+mask(%rip)                          #12.2
        vmovdqu   %ymm0, 96+mask(%rip)                          #12.2
                                # LOE rbx r12 r13 r14 r15
..B1.2:                         # Preds ..B1.27
        ...
        movl      $128, %esi                                    #12.2
        movl      $mask, %edx                                   #12.2
        orq       $12, mask(%rip)                               #12.2
        vzeroupper                                              #12.2
..___tag_value_main.6:
#       sched_setaffinity(__pid_t, size_t, const cpu_set_t *)
        call      sched_setaffinity                             #12.2
..___tag_value_main.7:
                                # LOE rbx r12 r13 r14 r15
..B1.3:                         # Preds ..B1.2
                                # Execution count [1.00e+00]
        movq      $.L_2__STRING.8, programName(%rip)            #14.2
        xorl      %ecx, %ecx                                    #15.2
        xorl      %esi, %esi                                    #15.2
...
..B1.5:                         # Preds ..B1.5 ..B1.4
        ...
        movl      %ecx, %r10d                                   #15.2
        movl      $274877907, %eax                              #15.2
        imull     %r8d, %r10d                                   #15.2
        incl      %r8d                                          #15.2
        imull     %r10d                                         #15.2
        sarl      $6, %edx                                      #15.2
        imull     $-1000, %edx, %r9d                            #15.2
        addl      %r9d, %r10d                                   #15.2
        movl      %r10d, t(%rdi)                                #15.2
        addq      $4, %rdi                                      #15.2
        cmpl      $64, %r8d                                     #15.2
        jl        ..B1.5        # Prob 98%                      #15.2
                                # LOE rbx rsi rdi r12 r13 r14 r15 ecx r8d
..B1.6:                         # Preds ..B1.5
                                # Execution count [6.40e+01]
        incl      %ecx                                          #15.2
...
..B1.11:                        # Preds ..B1.11 ..B1.10
        ...
        vpermq    $216, t(%rax,%rsi,4), %ymm14                  #35.18
        vpermq    $216, 256+t(%rax,%rsi,4), %ymm15              #36.18
        vpermq    $216, 512+t(%rax,%rsi,4), %ymm3               #40.18
        vpermq    $216, 768+t(%rax,%rsi,4), %ymm0               #41.18
        vpunpckldq %ymm15, %ymm14, %ymm10                       #37.11
        vpunpckldq %ymm0, %ymm3, %ymm11                         #42.11
        vpunpckhdq %ymm15, %ymm14, %ymm2                        #38.11
        vpunpckhdq %ymm0, %ymm3, %ymm1                          #43.11
        vpermq    $216, 1024+t(%rax,%rsi,4), %ymm6              #45.18
        vpermq    $216, 1280+t(%rax,%rsi,4), %ymm8              #46.18
        vpermq    $216, 1536+t(%rax,%rsi,4), %ymm7              #50.11
        vpermq    $216, 1792+t(%rax,%rsi,4), %ymm9              #51.11
        addq      $8, %rsi                                      #23.18
        vpermq    $216, %ymm10, %ymm12                          #55.19
        vpermq    $216, %ymm11, %ymm13                          #56.19
        vpunpcklqdq %ymm13, %ymm12, %ymm5                       #57.12
        vpunpckhqdq %ymm13, %ymm12, %ymm4                       #58.12
        vpunpckldq %ymm8, %ymm6, %ymm12                         #47.11
        vpunpckldq %ymm9, %ymm7, %ymm13                         #52.11
        vpunpckhdq %ymm8, %ymm6, %ymm6                          #48.11
        vpunpckhdq %ymm9, %ymm7, %ymm7                          #53.11
        vpermq    $216, %ymm2, %ymm10                           #60.18
        vpermq    $216, %ymm1, %ymm11                           #61.18
        vpermq    $216, %ymm12, %ymm14                          #65.18
        vpermq    $216, %ymm13, %ymm15                          #66.18
        vpermq    $216, %ymm6, %ymm8                            #70.18
        vpermq    $216, %ymm7, %ymm9                            #71.18
        vpunpcklqdq %ymm11, %ymm10, %ymm3                       #62.12
        vpunpckhqdq %ymm11, %ymm10, %ymm2                       #63.12
        vpunpcklqdq %ymm15, %ymm14, %ymm1                       #67.12
        vpunpckhqdq %ymm15, %ymm14, %ymm0                       #68.12
        vpunpcklqdq %ymm9, %ymm8, %ymm6                         #72.12
        vpunpckhqdq %ymm9, %ymm8, %ymm7                         #73.12
        vperm2i128 $32, %ymm1, %ymm5, %ymm8                     #75.11
        vperm2i128 $49, %ymm1, %ymm5, %ymm5                     #76.11
        vperm2i128 $32, %ymm0, %ymm4, %ymm1                     #78.11
        vperm2i128 $49, %ymm0, %ymm4, %ymm4                     #79.11
        vperm2i128 $32, %ymm6, %ymm3, %ymm0                     #81.11
        vperm2i128 $49, %ymm6, %ymm3, %ymm3                     #82.11
        vperm2i128 $32, %ymm7, %ymm2, %ymm6                     #84.11
        vperm2i128 $49, %ymm7, %ymm2, %ymm2                     #85.11
        vmovdqu   %ymm8, c_tra(%rcx)                            #88.35
        vmovdqu   %ymm5, 256+c_tra(%rcx)                        #89.35
        vmovdqu   %ymm1, 512+c_tra(%rcx)                        #90.35
        vmovdqu   %ymm4, 768+c_tra(%rcx)                        #91.35
        vmovdqu   %ymm0, 1024+c_tra(%rcx)                       #92.35
        vmovdqu   %ymm3, 1280+c_tra(%rcx)                       #93.35
        vmovdqu   %ymm6, 1536+c_tra(%rcx)                       #94.35
        vmovdqu   %ymm2, 1792+c_tra(%rcx)                       #95.35
        addq      $2048, %rcx                                   #23.18
        cmpq      $64, %rsi                                     #23.13
        jl        ..B1.11       # Prob 87%                      #23.13
                                # LOE rax rdx rcx rbx rsi r12 r13 r14 r15
..B1.12:                        # Preds ..B1.11
                                # Execution count [2.33e+01]
        addq      $8, %rdx                                      #22.18
...
..B1.31:                        # Preds ..B1.32
                                # Execution count [2.91e+00]
        movq      t2_rdtsc(%rip), %rdx                          #102.3
        subq      t1_rdtsc(%rip), %rdx                          #102.3
        movq      ttbest_rdtsc(%rip), %rsi                      #102.3
        movq      %rdx, ttotal_rdtsc(%rip)                      #102.3
        cmpq      %rsi, %rdx                                    #102.3
        jge       ..B1.16       # Prob 50%                      #102.3
                                # LOE rdx rbx rsi r12 r13 r14 r15
..B1.15:                        # Preds ..B1.31
                                # Execution count [1.45e+00]
        movq      elapsed_rdtsc(%rip), %rcx                     #102.3
        movq      %rcx, %rax                                    #102.3
        negq      %rax                                          #102.3
        movq      %rdx, %rsi                                    #102.3
        addq      $9999999, %rax                                #102.3
        movq      %rdx, ttbest_rdtsc(%rip)                      #102.3
        movq      %rax, elapsed(%rip)                           #102.3
        jmp       ..B1.17       # Prob 100%                     #102.3
...
..B1.17:                        # Preds ..B1.15 ..B1.16
                                # Execution count [2.91e+00]
        movq      ttime(%rip), %rax                             #102.3
        addq      %rdx, %rax                                    #102.3
        movq      %rax, ttime(%rip)                             #102.3
        testq     %rcx, %rcx                                    #102.3
        je        ..B1.20       # Prob 50%                      #102.3
                                # LOE rax rcx rbx rsi r12 r13 r14 r15
..B1.18:                        # Preds ..B1.17
                                # Execution count [1.45e+00]
        decq      %rcx                                          #102.3
        movq      %rcx, elapsed_rdtsc(%rip)                     #102.3
        cmpq      overal_time(%rip), %rax                       #102.3
        jl        ..B1.8        # Prob 82%                      #102.3
        jmp       ..B1.21       # Prob 100%                     #102.3
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.20:                        # Preds ..B1.17
                                # Execution count [1.45e+00]
        movq      $-1, elapsed_rdtsc(%rip)                      #102.3
        movq      $-1, %rcx                                     #102.3
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.21:                        # Preds ..B1.18 ..B1.20
                                # Execution count [1.00e+00]
        negq      %rcx                                          #102.3
        movl      $.L_2__STRING.9, %edi                         #102.3
        addq      $9999999, %rcx                                #102.3
        xorl      %eax, %eax                                    #102.3
        movq      elapsed(%rip), %rdx                           #102.3
..___tag_value_main.8:
...
..B1.22:                        # Preds ..B1.21
                                # Execution count [1.00e+00]
        movl      $.L_2__STRING.10, %edi                        #102.3
        movl      $.L_2__STRING.11, %esi                        #102.3
...
..B1.23:                        # Preds ..B1.22
        ...
        movl      $64, %ecx                                     #102.3
        movq      %rax, %rdi                                    #102.3
        movq      %rax, fileForSpeedups(%rip)                   #102.3
        movl      $.L_2__STRING.12, %esi                        #102.3
        movl      %ecx, %r8d                                    #102.3
        xorl      %eax, %eax                                    #102.3
        movq      programName(%rip), %rdx                       #102.3
        movq      ttbest_rdtsc(%rip), %r9                       #102.3
