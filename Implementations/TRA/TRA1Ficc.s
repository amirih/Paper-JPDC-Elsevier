...
# mark_description "-D _GNU_SOURCE -Ofast -march=native -S -c -o TRA1Ficc.s";
	.file "TRA1F.c"
	.text
..TXTST0:
...
..L2:
	...
	.cfi_offset 6, -16
        ...
        xorl      %esi, %esi                                    #30.1
        movl      $3, %edi                                      #30.1
        call      __intel_new_feature_proc_init                 #30.1
                                # LOE rbx r12 r13 r14 r15
..B1.26:                        # Preds ..B1.1
                                # Execution count [1.00e+00]
        vstmxcsr  (%rsp)                                        #30.1
        vpxor     %ymm0, %ymm0, %ymm0                           #32.2
        orl       $32832, (%rsp)                                #30.1
        vldmxcsr  (%rsp)                                        #30.1
        movq      $.L_2__STRING.8, programName(%rip)            #31.2
        vmovdqu   %ymm0, mask(%rip)                             #32.2
        vmovdqu   %ymm0, 32+mask(%rip)                          #32.2
        vmovdqu   %ymm0, 64+mask(%rip)                          #32.2
        vmovdqu   %ymm0, 96+mask(%rip)                          #32.2
                                # LOE rbx r12 r13 r14 r15
..B1.2:                         # Preds ..B1.26
        ...
        movl      $128, %esi                                    #32.2
        movl      $mask, %edx                                   #32.2
        orq       $12, mask(%rip)                               #32.2
        vzeroupper                                              #32.2
..___tag_value_main.6:
#       sched_setaffinity(__pid_t, size_t, const cpu_set_t *)
        call      sched_setaffinity                             #32.2
..___tag_value_main.7:
                                # LOE rbx r12 r13 r14 r15
..B1.3:                         # Preds ..B1.2
                                # Execution count [1.00e+00]
        vmovdqu   .L_2il0floatpacket.1(%rip), %ymm15            #33.2
        xorl      %edi, %edi                                    #33.2
        vmovdqu   .L_2il0floatpacket.2(%rip), %ymm10            #33.2
        vmovdqu   .L_2il0floatpacket.3(%rip), %ymm9             #33.2
        vpaddd    %ymm15, %ymm10, %ymm14                        #33.2
        vpaddd    %ymm15, %ymm9, %ymm4                          #33.2
        vmovupd   .L_2il0floatpacket.4(%rip), %ymm10            #33.2
        vpaddd    %ymm15, %ymm14, %ymm7                         #33.2
        vpaddd    %ymm15, %ymm4, %ymm3                          #33.2
        vmovdqu   %ymm4, 160(%rsp)                              #33.2[spill]
        vpaddd    %ymm15, %ymm7, %ymm6                          #33.2
        vpaddd    %ymm15, %ymm3, %ymm2                          #33.2
        vmovdqu   %ymm3, 32(%rsp)                               #33.2[spill]
        vmovdqu   %ymm7, 256(%rsp)                              #33.2[spill]
        vmovdqu   %ymm6, 288(%rsp)                              #33.2[spill]
        vmovdqu   %ymm2, (%rsp)                                 #33.2[spill]
        vpaddd    %ymm15, %ymm6, %ymm13                         #33.2
        vpaddd    %ymm15, %ymm2, %ymm1                          #33.2
        vpaddd    %ymm15, %ymm13, %ymm12                        #33.2
        vpaddd    %ymm15, %ymm1, %ymm0                          #33.2
        vmovdqu   %ymm1, 192(%rsp)                              #33.2[spill]
        vpaddd    %ymm15, %ymm12, %ymm11                        #33.2
        vpaddd    %ymm15, %ymm0, %ymm8                          #33.2
        vmovdqu   %ymm0, 224(%rsp)                              #33.2[spill]
        vpaddd    %ymm15, %ymm11, %ymm5                         #33.2
        vpaddd    %ymm15, %ymm8, %ymm15                         #33.2
        vmovdqu   %ymm8, 96(%rsp)                               #33.2[spill]
        vmovupd   .L_2il0floatpacket.6(%rip), %ymm8             #33.2
        vmovdqu   %ymm5, 128(%rsp)                              #33.2[spill]
        vmovdqu   %ymm15, 64(%rsp)                              #33.2[spill]
        xorl      %esi, %esi                                    #33.2
                                # LOE rbx rsi r12 r13 r14 r15 edi ymm8 ymm10 ymm11 ymm12 ymm13 ymm14
..B1.4:                         # Preds ..B1.27 ..B1.3
                                # Execution count [6.40e+01]
        vmovdqu   .L_2il0floatpacket.3(%rip), %ymm1             #33.2
        vmovd     %edi, %xmm2                                   #33.2
        vpbroadcastd %xmm2, %ymm9                               #33.2
        vmovdqa   %ymm9, %ymm0                                  #33.2
        vpmulld   .L_2il0floatpacket.2(%rip), %ymm9, %ymm15     #33.2
..___tag_value_main.18:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #33.2
..___tag_value_main.19:
                                # LOE rbx rsi r12 r13 r14 r15 edi ymm0 ymm8 ymm9 ymm10 ymm11 ymm12 ymm13 ymm14 ymm15
..B1.34:                        # Preds ..B1.4
                                # Execution count [6.40e+01]
        vpaddd    %ymm0, %ymm15, %ymm2                          #33.2
        vpshufd   $49, %ymm2, %ymm4                             #33.2
        vpmuldq   %ymm8, %ymm2, %ymm3                           #33.2
        vpmuldq   %ymm8, %ymm4, %ymm5                           #33.2
        vpsrlq    $32, %ymm3, %ymm6                             #33.2
        vpand     .L_2il0floatpacket.7(%rip), %ymm5, %ymm7      #33.2
        vpsrad    $31, %ymm2, %ymm3                             #33.2
        vpor      %ymm7, %ymm6, %ymm15                          #33.2
        vpsrad    $6, %ymm15, %ymm1                             #33.2
        vpsubd    %ymm3, %ymm1, %ymm4                           #33.2
        vpmulld   .L_2il0floatpacket.8(%rip), %ymm4, %ymm5      #33.2
        vpsubd    %ymm5, %ymm2, %ymm2                           #33.2
        vmovdqa   %ymm9, %ymm0                                  #33.2
        vextracti128 $1, %ymm2, %xmm6                           #33.2
        vcvtdq2pd %xmm2, %ymm7                                  #33.2
        vcvtdq2pd %xmm6, %ymm15                                 #33.2
        vaddpd    %ymm7, %ymm10, %ymm1                          #33.2
        vaddpd    %ymm15, %ymm10, %ymm2                         #33.2
        vcvtpd2ps %ymm1, %xmm1                                  #33.2
        vcvtpd2ps %ymm2, %xmm2                                  #33.2
        vpmulld   %ymm9, %ymm14, %ymm15                         #33.2
        vinsertf128 $1, %xmm2, %ymm1, %ymm1                     #33.2
        vmovups   %ymm1, t(%rsi)                                #33.2
        vmovdqu   160(%rsp), %ymm1                              #33.2[spill]
...
..B1.33:                        # Preds ..B1.34
        ...
        vcvtpd2ps %ymm1, %xmm1                                  #33.2
        vcvtpd2ps %ymm2, %xmm2                                  #33.2
        vpmulld   256(%rsp), %ymm9, %ymm15                      #33.2[spill]
        vinsertf128 $1, %xmm2, %ymm1, %ymm1                     #33.2
        vmovups   %ymm1, 32+t(%rsi)                             #33.2
        vmovdqu   32(%rsp), %ymm1                               #33.2[spill]
...
..B1.32:                        # Preds ..B1.33
        ...
        vcvtpd2ps %ymm1, %xmm1                                  #33.2
        vcvtpd2ps %ymm2, %xmm2                                  #33.2
        vpmulld   288(%rsp), %ymm9, %ymm15                      #33.2[spill]
        vinsertf128 $1, %xmm2, %ymm1, %ymm1                     #33.2
        vmovups   %ymm1, 64+t(%rsi)                             #33.2
        vmovdqu   (%rsp), %ymm1                                 #33.2[spill]
...
..B1.31:                        # Preds ..B1.32
        ...
        vcvtpd2ps %ymm1, %xmm1                                  #33.2
        vcvtpd2ps %ymm2, %xmm2                                  #33.2
        vpmulld   %ymm9, %ymm13, %ymm15                         #33.2
        vinsertf128 $1, %xmm2, %ymm1, %ymm1                     #33.2
        vmovups   %ymm1, 96+t(%rsi)                             #33.2
        vmovdqu   192(%rsp), %ymm1                              #33.2[spill]
...
..B1.30:                        # Preds ..B1.31
        ...
        vcvtpd2ps %ymm1, %xmm1                                  #33.2
        vcvtpd2ps %ymm2, %xmm2                                  #33.2
        vpmulld   %ymm9, %ymm12, %ymm15                         #33.2
        vinsertf128 $1, %xmm2, %ymm1, %ymm1                     #33.2
        vmovups   %ymm1, 128+t(%rsi)                            #33.2
        vmovdqu   224(%rsp), %ymm1                              #33.2[spill]
...
..B1.29:                        # Preds ..B1.30
        ...
        vcvtpd2ps %ymm1, %xmm1                                  #33.2
        vcvtpd2ps %ymm2, %xmm2                                  #33.2
        vpmulld   %ymm9, %ymm11, %ymm15                         #33.2
        vinsertf128 $1, %xmm2, %ymm1, %ymm1                     #33.2
        vmovups   %ymm1, 160+t(%rsi)                            #33.2
        vmovdqu   96(%rsp), %ymm1                               #33.2[spill]
...
..B1.28:                        # Preds ..B1.29
        ...
        vcvtpd2ps %ymm1, %xmm1                                  #33.2
        vcvtpd2ps %ymm2, %xmm2                                  #33.2
        vpmulld   128(%rsp), %ymm9, %ymm15                      #33.2[spill]
        vinsertf128 $1, %xmm2, %ymm1, %ymm1                     #33.2
        vmovups   %ymm1, 192+t(%rsi)                            #33.2
        vmovdqu   64(%rsp), %ymm1                               #33.2[spill]
..___tag_value_main.41:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #33.2
..___tag_value_main.42:
                                # LOE rbx rsi r12 r13 r14 r15 edi ymm0 ymm8 ymm10 ymm11 ymm12 ymm13 ymm14 ymm15
..B1.27:                        # Preds ..B1.28
                                # Execution count [6.40e+01]
        vpaddd    %ymm0, %ymm15, %ymm0                          #33.2
        incl      %edi                                          #33.2
        vpshufd   $49, %ymm0, %ymm2                             #33.2
        vpsrad    $31, %ymm0, %ymm9                             #33.2
        vpmuldq   %ymm8, %ymm0, %ymm1                           #33.2
        vpmuldq   %ymm8, %ymm2, %ymm3                           #33.2
        vpsrlq    $32, %ymm1, %ymm4                             #33.2
        vpand     .L_2il0floatpacket.7(%rip), %ymm3, %ymm5      #33.2
        vpor      %ymm5, %ymm4, %ymm6                           #33.2
        vpsrad    $6, %ymm6, %ymm7                              #33.2
        vpsubd    %ymm9, %ymm7, %ymm15                          #33.2
        vpmulld   .L_2il0floatpacket.8(%rip), %ymm15, %ymm1     #33.2
        vpsubd    %ymm1, %ymm0, %ymm0                           #33.2
        vextracti128 $1, %ymm0, %xmm2                           #33.2
        vcvtdq2pd %xmm0, %ymm3                                  #33.2
        vcvtdq2pd %xmm2, %ymm4                                  #33.2
        vaddpd    %ymm3, %ymm10, %ymm5                          #33.2
        vaddpd    %ymm4, %ymm10, %ymm6                          #33.2
        vcvtpd2ps %ymm5, %xmm7                                  #33.2
        vcvtpd2ps %ymm6, %xmm9                                  #33.2
        vinsertf128 $1, %xmm9, %ymm7, %ymm15                    #33.2
        vmovups   %ymm15, 224+t(%rsi)                           #33.2
        addq      $256, %rsi                                    #33.2
        cmpl      $64, %edi                                     #33.2
        jb        ..B1.4        # Prob 98%                      #33.2
                                # LOE rbx rsi r12 r13 r14 r15 edi ymm8 ymm10 ymm11 ymm12 ymm13 ymm14
..B1.5:                         # Preds ..B1.27
                                # Execution count [1.72e+00]
        movq      $0x4a817c7ff, %rax                            #36.2
        movq      $9999999, elapsed_rdtsc(%rip)                 #36.2
        movq      %rax, overal_time(%rip)                       #36.2
        movq      $0, ttime(%rip)                               #36.2
                                # LOE rbx r12 r13 r14 r15
...
..B1.8:                         # Preds ..B1.10 ..B1.7
        ...
        xorl      %esi, %esi                                    #38.3
        movq      %rdx, %rcx                                    #40.5
                                # LOE rax rdx rcx rbx rsi r12 r13 r14 r15 dil
..B1.9:                         # Preds ..B1.9 ..B1.8
                                # Execution count [1.19e+04]
        vmovss    t(%rsi,%rax,4), %xmm0                         #40.19
        addb      $2, %dil                                      #38.3
        vinsertps $16, 256+t(%rsi,%rax,4), %xmm0, %xmm1         #40.19
        addq      $512, %rsi                                    #38.3
        vmovlps   %xmm1, c_tra(%rcx)                            #40.5
        addq      $8, %rcx                                      #38.3
        cmpb      $64, %dil                                     #38.3
        jb        ..B1.9        # Prob 98%                      #38.3
                                # LOE rax rdx rcx rbx rsi r12 r13 r14 r15 dil
..B1.10:                        # Preds ..B1.9
                                # Execution count [1.86e+02]
        incq      %rax                                          #39.4
...
..B1.38:                        # Preds ..B1.39
                                # Execution count [2.91e+00]
        movq      t2_rdtsc(%rip), %rdx                          #45.2
        subq      t1_rdtsc(%rip), %rdx                          #45.2
        movq      ttbest_rdtsc(%rip), %rsi                      #45.2
        movq      %rdx, ttotal_rdtsc(%rip)                      #45.2
        cmpq      %rsi, %rdx                                    #45.2
        jge       ..B1.14       # Prob 50%                      #45.2
                                # LOE rdx rbx rsi r12 r13 r14 r15
..B1.13:                        # Preds ..B1.38
                                # Execution count [1.45e+00]
        movq      elapsed_rdtsc(%rip), %rcx                     #45.2
        movq      %rcx, %rax                                    #45.2
        negq      %rax                                          #45.2
        movq      %rdx, %rsi                                    #45.2
        addq      $9999999, %rax                                #45.2
        movq      %rdx, ttbest_rdtsc(%rip)                      #45.2
        movq      %rax, elapsed(%rip)                           #45.2
        jmp       ..B1.15       # Prob 100%                     #45.2
...
..B1.15:                        # Preds ..B1.13 ..B1.14
                                # Execution count [2.91e+00]
        movq      ttime(%rip), %rax                             #45.2
        addq      %rdx, %rax                                    #45.2
        movq      %rax, ttime(%rip)                             #45.2
        testq     %rcx, %rcx                                    #45.2
        je        ..B1.18       # Prob 50%                      #45.2
                                # LOE rax rcx rbx rsi r12 r13 r14 r15
..B1.16:                        # Preds ..B1.15
                                # Execution count [1.45e+00]
        decq      %rcx                                          #45.2
        movq      %rcx, elapsed_rdtsc(%rip)                     #45.2
        cmpq      overal_time(%rip), %rax                       #45.2
        jl        ..B1.6        # Prob 82%                      #45.2
        jmp       ..B1.19       # Prob 100%                     #45.2
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.18:                        # Preds ..B1.15
                                # Execution count [1.45e+00]
        movq      $-1, elapsed_rdtsc(%rip)                      #45.2
        movq      $-1, %rcx                                     #45.2
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.19:                        # Preds ..B1.16 ..B1.18
                                # Execution count [1.00e+00]
        negq      %rcx                                          #45.2
        movl      $.L_2__STRING.9, %edi                         #45.2
        addq      $9999999, %rcx                                #45.2
        xorl      %eax, %eax                                    #45.2
        movq      elapsed(%rip), %rdx                           #45.2
...
..B1.20:                        # Preds ..B1.19
                                # Execution count [1.00e+00]
        movl      $.L_2__STRING.10, %edi                        #45.2
        movl      $.L_2__STRING.11, %esi                        #45.2
...
..B1.21:                        # Preds ..B1.20
        ...
        movl      $64, %ecx                                     #45.2
        movq      %rax, %rdi                                    #45.2
        movq      %rax, fileForSpeedups(%rip)                   #45.2
        movl      $.L_2__STRING.12, %esi                        #45.2
        movl      %ecx, %r8d                                    #45.2
        xorl      %eax, %eax                                    #45.2
        movq      programName(%rip), %rdx                       #45.2
        movq      ttbest_rdtsc(%rip), %r9                       #45.2
#       fprintf(FILE *__restrict__, const char *__restrict__, ...)
        call      fprintf                                       #45.2
                                # LOE rbx r12 r13 r14 r15
..B1.22:                        # Preds ..B1.21
                                # Execution count [1.00e+00]
        vxorpd    %xmm0, %xmm0, %xmm0                           #46.4
        movl      $.L_2__STRING.13, %edi                        #46.4
        movl      $1, %eax                                      #46.4
        vcvtss2sd 8320+c_tra(%rip), %xmm0, %xmm0                #46.4
...
..B2.1:                         # Preds ..B2.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignToThisCore12.51:
..L52:
                                                         #51.1
...
..B3.1:                         # Preds ..B3.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignImagef32.54:
..L55:
                                                         #65.1
        pushq     %rbp                                          #65.1
	.cfi_def_cfa_offset 16
...
..___tag_value_assignImagef32.60:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #71.37
..___tag_value_assignImagef32.61:
...
..___tag_value_assignMatrixf32.82:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #84.35
..___tag_value_assignMatrixf32.83:
...
..___tag_value_assignMatrixf32.86:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #84.35
..___tag_value_assignMatrixf32.87:
...
..___tag_value_assignMatrixf32.89:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #84.35
..___tag_value_assignMatrixf32.90:
        vmovupd   .L_2il0floatpacket.6(%rip), %ymm3             #84.35
...
..___tag_value_assignMatrixf32.92:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #84.35
..___tag_value_assignMatrixf32.93:
        vmovupd   .L_2il0floatpacket.6(%rip), %ymm3             #84.35
...
..___tag_value_assignMatrixf32.95:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #84.35
..___tag_value_assignMatrixf32.96:
        vmovupd   .L_2il0floatpacket.6(%rip), %ymm3             #84.35
...
..___tag_value_assignMatrixf32.98:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #84.35
..___tag_value_assignMatrixf32.99:
...
..___tag_value_assignMatrixf32.102:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #84.35
..___tag_value_assignMatrixf32.103:
        vmovupd   .L_2il0floatpacket.6(%rip), %ymm3             #84.35
...
..___tag_value_assignMatrixf32.106:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #84.35
..___tag_value_assignMatrixf32.107:
...
..___tag_value_assignImagei32.127:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #96.4
..___tag_value_assignImagei32.128:
...
..___tag_value_assignImagei32.130:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #96.4
..___tag_value_assignImagei32.131:
...
..___tag_value_assignImagei32.133:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #96.4
..___tag_value_assignImagei32.134:
...
..___tag_value_assignImagei32.136:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #96.4
..___tag_value_assignImagei32.137:
        vmovupd   .L_2il0floatpacket.16(%rip), %ymm3            #96.4
...
..___tag_value_assignImagei32.139:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #96.4
..___tag_value_assignImagei32.140:
        vmovupd   .L_2il0floatpacket.16(%rip), %ymm3            #96.4
...
..___tag_value_assignImagei32.143:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #96.4
..___tag_value_assignImagei32.144:
...
..___tag_value_assignImagei32.146:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #96.4
..___tag_value_assignImagei32.147:
        vmovupd   .L_2il0floatpacket.16(%rip), %ymm3            #96.4
...
..___tag_value_assignImagei32.149:
        call      *__svml_idiv8_l9@GOTPCREL(%rip)               #96.4
...
..B6.1:                         # Preds ..B6.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignMatrixi32.156:
..L157:
                                                        #103.1
        xorl      %edx, %edx                                    #105.2
...
..B7.1:                         # Preds ..B7.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignMatrixi16.159:
..L160:
                                                        #116.1
        pushq     %r12                                          #116.1
	.cfi_def_cfa_offset 16
...
..B8.1:                         # Preds ..B8.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignImagei16.174:
..L175:
                                                        #128.1
        pushq     %r12                                          #128.1
	.cfi_def_cfa_offset 16
...
..B9.1:                         # Preds ..B9.0
	...
	.cfi_startproc
..___tag_value_imageTranspose.189:
..L190:
                                                        #140.1
        pushq     %rbx                                          #140.1
	.cfi_def_cfa_offset 16
...
..B10.1:                        # Preds ..B10.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignMatrixui16.196:
..L197:
                                                        #152.1
        xorl      %eax, %eax                                    #154.6
...
..B11.1:                        # Preds ..B11.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignMatrixi8.199:
..L200:
                                                        #165.1
        pushq     %r12                                          #165.1
	.cfi_def_cfa_offset 16
...
..B12.1:                        # Preds ..B12.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignArrayi32.214:
..L215:
                                                        #178.1
        movq      %rdi, %r8                                     #180.3
        andq      $31, %r8                                      #180.3
...
..B13.1:                        # Preds ..B13.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_savefloatMatrixFileForOutPuts.217:
..L218:
                                                        #494.56
        pushq     %r12                                          #494.56
	.cfi_def_cfa_offset 16
...
..B14.1:                        # Preds ..B14.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_savefloatMatrixFileName.238:
..L239:
                                                        #509.66
        pushq     %r12                                          #509.66
	.cfi_def_cfa_offset 16
...
..B15.1:                        # Preds ..B15.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_saveintMatrixFileForOutPuts.259:
..L260:
                                                        #524.52
        pushq     %r12                                          #524.52
	.cfi_def_cfa_offset 16
...
..B16.1:                        # Preds ..B16.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_saveintMatrixFileName.280:
..L281:
                                                        #538.62
        pushq     %r12                                          #538.62
	.cfi_def_cfa_offset 16
