...
# mark_description "-D _GNU_SOURCE -O3 -xHOST -S -c -o FIR1icc.s";
	.file "FIR1.c"
	.text
..TXTST0:
...
..B1.23:                        # Preds ..B1.1
                                # Execution count [1.00e+00]
        vstmxcsr  (%rsp)                                        #19.1
        vpxor     %ymm0, %ymm0, %ymm0                           #20.2
        orl       $32832, (%rsp)                                #19.1
        vldmxcsr  (%rsp)                                        #19.1
        vmovdqu   %ymm0, mask(%rip)                             #20.2
        vmovdqu   %ymm0, 32+mask(%rip)                          #20.2
        vmovdqu   %ymm0, 64+mask(%rip)                          #20.2
        vmovdqu   %ymm0, 96+mask(%rip)                          #20.2
                                # LOE rbx r12 r13 r14 r15
..B1.2:                         # Preds ..B1.23
        ...
        movl      $128, %esi                                    #20.2
        movl      $mask, %edx                                   #20.2
        orq       $12, mask(%rip)                               #20.2
        vzeroupper                                              #20.2
..___tag_value_main.6:
#       sched_setaffinity(__pid_t, size_t, const cpu_set_t *)
        call      sched_setaffinity                             #20.2
..___tag_value_main.7:
                                # LOE rbx r12 r13 r14 r15
..B1.3:                         # Preds ..B1.2
                                # Execution count [1.00e+00]
        vmovdqu   .L_2il0floatpacket.1(%rip), %ymm3             #21.2
        xorl      %eax, %eax                                    #21.2
        vmovdqu   .L_2il0floatpacket.2(%rip), %ymm2             #21.2
        vmovdqu   .L_2il0floatpacket.3(%rip), %ymm1             #21.2
        vmovupd   .L_2il0floatpacket.5(%rip), %ymm0             #21.17
                                # LOE rax rbx r12 r13 r14 r15 ymm0 ymm1 ymm2 ymm3
..B1.4:                         # Preds ..B1.4 ..B1.3
                                # Execution count [4.10e+03]
        vpmulld   %ymm1, %ymm2, %ymm13                          #21.2
        vpshufd   $49, %ymm13, %ymm4                            #21.17
        vpsrad    $31, %ymm13, %ymm11                           #21.17
        vpaddd    %ymm3, %ymm2, %ymm2                           #21.2
        vpaddd    %ymm3, %ymm1, %ymm1                           #21.2
        vpmuldq   %ymm0, %ymm13, %ymm5                          #21.17
        vpmuldq   %ymm0, %ymm4, %ymm6                           #21.17
        vpsrlq    $32, %ymm5, %ymm7                             #21.17
        vpand     .L_2il0floatpacket.6(%rip), %ymm6, %ymm8      #21.17
        vpor      %ymm8, %ymm7, %ymm9                           #21.17
        vpsrad    $6, %ymm9, %ymm10                             #21.17
        vpsubd    %ymm11, %ymm10, %ymm12                        #21.17
        vpmulld   .L_2il0floatpacket.7(%rip), %ymm12, %ymm14    #21.17
        vpsubd    %ymm14, %ymm13, %ymm15                        #21.17
        vmovdqu   %ymm15, input(,%rax,4)                        #21.17
        addq      $8, %rax                                      #21.2
        cmpq      $4096, %rax                                   #21.2
        jb        ..B1.4        # Prob 99%                      #21.2
                                # LOE rax rbx r12 r13 r14 r15 ymm0 ymm1 ymm2 ymm3
..B1.5:                         # Preds ..B1.4
                                # Execution count [1.72e+00]
        movq      $0x4a817c7ff, %rax                            #25.2
        movq      $.L_2__STRING.8, programName(%rip)            #23.2
        movq      $9999999, elapsed_rdtsc(%rip)                 #25.2
        movq      %rax, overal_time(%rip)                       #25.2
        movq      $0, ttime(%rip)                               #25.2
                                # LOE rbx r12 r13 r14 r15
...
..B1.7:                         # Preds ..B1.25
                                # Execution count [2.91e+00]
        movq      %rax, t1_rdtsc(%rip)                          #25.2
        xorl      %eax, %eax                                    #28.3
        vmovdqu   coeff(%rip), %ymm0                            #30.18
        vpxor     %ymm1, %ymm1, %ymm1                           #30.18
                                # LOE rax rbx r12 r13 r14 r15 ymm0 ymm1
..B1.8:                         # Preds ..B1.8 ..B1.7
                                # Execution count [5.95e+03]
        vpmulld   4+input(,%rax,8), %ymm0, %ymm2                #30.5
        vpmulld   input(,%rax,8), %ymm0, %ymm10                 #30.5
        vpaddd    %ymm2, %ymm1, %ymm3                           #30.5
        vpaddd    %ymm10, %ymm1, %ymm11                         #30.5
        vextractf128 $1, %ymm3, %xmm4                           #30.5
        vextractf128 $1, %ymm11, %xmm12                         #30.5
        vpaddd    %xmm4, %xmm3, %xmm5                           #30.5
        vpaddd    %xmm12, %xmm11, %xmm13                        #30.5
        vpsrldq   $8, %xmm5, %xmm6                              #30.5
        vpsrldq   $8, %xmm13, %xmm14                            #30.5
        vpaddd    %xmm6, %xmm5, %xmm7                           #30.5
        vpaddd    %xmm14, %xmm13, %xmm15                        #30.5
        vpsrlq    $32, %xmm7, %xmm8                             #30.5
        vpsrlq    $32, %xmm15, %xmm2                            #30.5
        vpaddd    %xmm8, %xmm7, %xmm9                           #30.5
        vpaddd    %xmm2, %xmm15, %xmm3                          #30.5
        vmovd     %xmm9, %edx                                   #30.5
        vmovd     %xmm3, %ecx                                   #30.5
        addl      %edx, 4+output(,%rax,8)                       #30.5
        addl      %ecx, output(,%rax,8)                         #30.5
        incq      %rax                                          #28.3
        cmpq      $2048, %rax                                   #28.3
        jb        ..B1.8        # Prob 99%                      #28.3
                                # LOE rax rbx r12 r13 r14 r15 ymm0 ymm1
..B1.9:                         # Preds ..B1.8
                                # Execution count [2.91e+00]
        vzeroupper                                              #35.3
...
..B1.14:                        # Preds ..B1.13
        ...
        jl        ..B1.6        # Prob 82%                      #35.3
        jmp       ..B1.17       # Prob 100%                     #35.3
...
..B1.16:                        # Preds ..B1.13
        ...
        movq      $-1, %rcx                                     #35.3
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.17:                        # Preds ..B1.14 ..B1.16
                                # Execution count [1.00e+00]
        negq      %rcx                                          #35.3
        movl      $.L_2__STRING.9, %edi                         #35.3
        addq      $9999999, %rcx                                #35.3
        xorl      %eax, %eax                                    #35.3
...
..B1.18:                        # Preds ..B1.17
                                # Execution count [1.00e+00]
        movl      $.L_2__STRING.10, %edi                        #35.3
        movl      $.L_2__STRING.11, %esi                        #35.3
...
..L17:
	...
	.cfi_offset 6, -16
        ...
        vmovdqu   .L_2il0floatpacket.3(%rip), %ymm3             #71.4
        vmovdqu   .L_2il0floatpacket.8(%rip), %ymm2             #71.32
...
..___tag_value_assignImagef32.23:
        ...
        vpand     .L_2il0floatpacket.6(%rip), %ymm6, %ymm3      #71.37
...
..B3.4:                         # Preds ..B3.3
        ...
        incl      %esi                                          #67.2
        addq      $272, %rdi                                    #67.2
        vmovdqu   .L_2il0floatpacket.8(%rip), %ymm2             #
        vmovsd    .L_2il0floatpacket.10(%rip), %xmm4            #
        vmovsd    .L_2il0floatpacket.9(%rip), %xmm5             #
        vmovdqu   .L_2il0floatpacket.3(%rip), %ymm3             #
        cmpl      $64, %esi                                     #67.2
...
..B4.2:                         # Preds ..B4.2 ..B4.1
                                # Execution count [6.40e+01]
        vmovdqu   .L_2il0floatpacket.8(%rip), %ymm1             #84.30
        vmovd     %esi, %xmm2                                   #79.19
        vpbroadcastd %xmm2, %ymm9                               #79.19
        incl      %esi                                          #79.2
        vmovdqa   %ymm9, %ymm0                                  #84.30
        vpmulld   .L_2il0floatpacket.3(%rip), %ymm9, %ymm15     #84.19
...
..___tag_value_assignMatrixf32.49:
        vmovupd   .L_2il0floatpacket.5(%rip), %ymm3             #84.35
        ...
        vpand     .L_2il0floatpacket.6(%rip), %ymm4, %ymm6      #84.35
        ...
        vpmulld   .L_2il0floatpacket.7(%rip), %ymm8, %ymm8      #84.35
...
..___tag_value_assignMatrixf32.52:
        ...
        vpmuldq   %ymm3, %ymm2, %ymm4                           #84.35
        vpsrlq    $32, %ymm8, %ymm5                             #84.35
        vpand     .L_2il0floatpacket.6(%rip), %ymm4, %ymm1      #84.35
...
..___tag_value_assignMatrixf32.58:
        ...
        vpsrlq    $32, %ymm8, %ymm5                             #84.35
        vpand     .L_2il0floatpacket.6(%rip), %ymm1, %ymm6      #84.35
...
..___tag_value_assignMatrixf32.61:
        vmovupd   .L_2il0floatpacket.5(%rip), %ymm1             #84.35
...
..___tag_value_assignMatrixf32.65:
        ...
        vpmulld   .L_2il0floatpacket.7(%rip), %ymm2, %ymm2      #84.35
...
..___tag_value_assignMatrixf32.69:
        vmovupd   .L_2il0floatpacket.5(%rip), %ymm8             #84.35
        ...
        vpand     .L_2il0floatpacket.6(%rip), %ymm1, %ymm4      #84.35
        vpor      %ymm4, %ymm3, %ymm5                           #84.35
        vpsrad    $6, %ymm5, %ymm6                              #84.35
        vpsubd    %ymm7, %ymm6, %ymm9                           #84.35
        vpmulld   .L_2il0floatpacket.7(%rip), %ymm9, %ymm15     #84.35
...
..L75:
	...
	.cfi_offset 6, -16
        ...
        xorl      %esi, %esi                                    #92.2
        vmovdqu   .L_2il0floatpacket.3(%rip), %ymm9             #96.4
        vmovdqu   .L_2il0floatpacket.8(%rip), %ymm8             #96.30
        vpaddd    %ymm15, %ymm9, %ymm14                         #96.4
        vpaddd    %ymm15, %ymm8, %ymm4                          #96.30
        vmovupd   .L_2il0floatpacket.17(%rip), %ymm8            #92.2
...
..B5.2:                         # Preds ..B5.2 ..B5.1
                                # Execution count [6.40e+01]
        vmovdqu   .L_2il0floatpacket.8(%rip), %ymm1             #96.30
        vmovd     %esi, %xmm2                                   #92.19
        vpbroadcastd %xmm2, %ymm9                               #92.19
        incl      %esi                                          #92.2
        vmovdqa   %ymm9, %ymm0                                  #96.30
        vpmulld   .L_2il0floatpacket.3(%rip), %ymm9, %ymm15     #96.19
...
..___tag_value_assignImagei32.90:
        ...
        vpand     .L_2il0floatpacket.6(%rip), %ymm8, %ymm6      #96.4
        ...
        vpmulld   .L_2il0floatpacket.18(%rip), %ymm3, %ymm4     #96.4
...
..___tag_value_assignImagei32.93:
        vmovupd   .L_2il0floatpacket.17(%rip), %ymm8            #96.4
        ...
        vpand     .L_2il0floatpacket.6(%rip), %ymm2, %ymm4      #96.4
        ...
        vpmulld   .L_2il0floatpacket.18(%rip), %ymm8, %ymm8     #96.4
...
..___tag_value_assignImagei32.96:
        vmovupd   .L_2il0floatpacket.17(%rip), %ymm3            #96.4
        ...
        vpand     .L_2il0floatpacket.6(%rip), %ymm4, %ymm1      #96.4
        ...
        vpmulld   .L_2il0floatpacket.18(%rip), %ymm4, %ymm5     #96.4
...
..___tag_value_assignImagei32.99:
        ...
        vpand     .L_2il0floatpacket.6(%rip), %ymm4, %ymm6      #96.4
        vpsrad    $31, %ymm5, %ymm3                             #96.4
        vpor      %ymm6, %ymm1, %ymm7                           #96.4
        vpaddd    %ymm5, %ymm7, %ymm8                           #96.4
        vpsrad    $7, %ymm8, %ymm2                              #96.4
        vpsubd    %ymm3, %ymm2, %ymm4                           #96.4
        vpmulld   .L_2il0floatpacket.18(%rip), %ymm4, %ymm1     #96.4
...
..___tag_value_assignImagei32.102:
        ...
        vpsrlq    $32, %ymm8, %ymm5                             #96.4
        vpand     .L_2il0floatpacket.6(%rip), %ymm1, %ymm6      #96.4
        vpsrad    $31, %ymm4, %ymm3                             #96.4
        vpor      %ymm6, %ymm5, %ymm7                           #96.4
        vpaddd    %ymm4, %ymm7, %ymm8                           #96.4
        vpsrad    $7, %ymm8, %ymm2                              #96.4
        vpsubd    %ymm3, %ymm2, %ymm1                           #96.4
        vpmulld   .L_2il0floatpacket.18(%rip), %ymm1, %ymm5     #96.4
...
..___tag_value_assignImagei32.106:
        vmovupd   .L_2il0floatpacket.17(%rip), %ymm1            #96.4
...
..L119:
        ...
        xorl      %eax, %eax                                    #105.2
        vmovdqu   .L_2il0floatpacket.3(%rip), %ymm9             #110.4
        vmovupd   .L_2il0floatpacket.5(%rip), %ymm1             #110.4
...
..B6.2:                         # Preds ..B6.2 ..B6.1
        ...
        vpmuldq   %ymm1, %ymm10, %ymm12                         #110.4
        vpsrlq    $32, %ymm11, %ymm13                           #110.4
        vpand     .L_2il0floatpacket.6(%rip), %ymm12, %ymm15    #110.4
        vpsrad    $31, %ymm14, %ymm12                           #110.4
        vpor      %ymm15, %ymm13, %ymm10                        #110.4
        vpsrad    $6, %ymm10, %ymm11                            #110.4
        vpsubd    %ymm12, %ymm11, %ymm13                        #110.4
        vpmulld   .L_2il0floatpacket.7(%rip), %ymm13, %ymm15    #110.4
...
..B9.5:                         # Preds ..B9.4
        ...
        vmovups   .L_2il0floatpacket.19(%rip), %ymm0            #146.14
        .align    16,0x90
...
..B12.6:                        # Preds ..B12.4 ..B12.1
        ...
        vpaddd    .L_2il0floatpacket.20(%rip), %ymm2, %ymm0     #184.4
        vpaddd    .L_2il0floatpacket.20(%rip), %ymm4, %ymm3     #184.4
        vmovdqu   .L_2il0floatpacket.1(%rip), %ymm1             #184.4
        vmovupd   .L_2il0floatpacket.5(%rip), %ymm2             #184.4
        movl      %r8d, %r8d                                    #180.3
...
..B12.7:                        # Preds ..B12.7 ..B12.6
        ...
        vpand     .L_2il0floatpacket.6(%rip), %ymm6, %ymm8      #184.4
        vpor      %ymm8, %ymm7, %ymm9                           #184.4
        vpsrad    $6, %ymm9, %ymm10                             #184.4
        vpsubd    %ymm11, %ymm10, %ymm12                        #184.4
        vpmulld   .L_2il0floatpacket.7(%rip), %ymm12, %ymm14    #184.4
...
.L_2il0floatpacket.1:
	...
	.align 32
.L_2il0floatpacket.2:
	.long	0x000004d2,0x000004d3,0x000004d4,0x000004d5,0x000004d6,0x000004d7,0x000004d8,0x000004d9
