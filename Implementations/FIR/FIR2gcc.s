...
#NO_APP
	rdtsc
	vmovdqa	coeff_avx(%rip), %xmm10
	vmovdqa	coeff_avx+16(%rip), %xmm9
	vmovdqa	coeff_avx+32(%rip), %xmm8
	vmovdqa	coeff_avx+48(%rip), %xmm7
	vmovdqa	coeff_avx+64(%rip), %xmm6
	salq	$32, %rdx
	orq	%rdx, %rax
	vmovdqa	coeff_avx+80(%rip), %xmm5
	vmovdqa	coeff_avx+96(%rip), %xmm4
	vmovdqa	coeff_avx+112(%rip), %xmm3
	vmovdqa	input_avx(%rip), %xmm2
	vmovdqu	input_avx+4(%rip), %xmm12
	vmovdqu	input_avx+8(%rip), %xmm0
	vmovdqu	input_avx+12(%rip), %xmm11
	movq	%rax, t1_rdtsc(%rip)
	xorl	%eax, %eax
	.p2align 4,,10
	.p2align 3
.L95:
	vpmulld	%xmm2, %xmm10, %xmm2
	vpmulld	%xmm12, %xmm9, %xmm1
	vpmulld	%xmm11, %xmm7, %xmm11
	vpmulld	%xmm0, %xmm8, %xmm0
	vmovdqu	input_avx+20(%rax), %xmm12
	addq	$16, %rax
	vpaddd	%xmm1, %xmm2, %xmm1
	vmovdqu	input_avx(%rax), %xmm2
	vpaddd	%xmm11, %xmm0, %xmm0
	vpaddd	%xmm1, %xmm0, %xmm13
	vpmulld	%xmm12, %xmm5, %xmm14
	vpmulld	%xmm2, %xmm6, %xmm1
	vmovdqu	input_avx+8(%rax), %xmm0
	vmovdqu	input_avx+12(%rax), %xmm11
	vpaddd	%xmm14, %xmm1, %xmm1
	vpaddd	%xmm13, %xmm1, %xmm1
	vpmulld	%xmm11, %xmm3, %xmm14
	vpmulld	%xmm0, %xmm4, %xmm13
	vpaddd	%xmm14, %xmm13, %xmm13
	vpaddd	%xmm13, %xmm1, %xmm1
	vmovaps	%xmm1, output-16(%rax)
	cmpq	$16384, %rax
	jne	.L95
	rdtsc
	salq	$32, %rdx
