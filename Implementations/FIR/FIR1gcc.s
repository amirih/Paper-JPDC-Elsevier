...
.L115:
	...
	cmpq	$16356, %r11
	jne	.L115
	movl	input+16372(%rip), %r11d
	movl	input+16376(%rip), %r13d
	imull	%eax, %r11d
	imull	%r10d, %r13d
	movl	input+16388(%rip), %ebx
	addl	output+16372(%rip), %r11d
	addl	%r11d, %r13d
	movl	input+16380(%rip), %r11d
	movl	input+16396(%rip), %r14d
	imull	%r9d, %r11d
	movl	input+16400(%rip), %r15d
	vmovd	%eax, %xmm7
	addl	%r11d, %r13d
	movl	input+16384(%rip), %r11d
	vpshufd	$0, %xmm7, %xmm0
	imull	%r8d, %r11d
	vmovd	%r10d, %xmm3
	vpmulld	input+16356(%rip), %xmm0, %xmm0
	addl	%r13d, %r11d
	movl	%edi, %r13d
	imull	%ebx, %r13d
	vpaddd	output+16356(%rip), %xmm0, %xmm0
	vmovd	%r9d, %xmm4
	addl	%r11d, %r13d
	movl	input+16392(%rip), %r11d
	vpshufd	$0, %xmm3, %xmm1
	imull	%esi, %r11d
	vmovd	%r8d, %xmm5
	vpmulld	input+16360(%rip), %xmm1, %xmm1
	addl	%r11d, %r13d
	movl	%ecx, %r11d
	imull	%r14d, %r11d
	...
	imull	%r15d, %r13d
	vmovd	%edi, %xmm6
	vpmulld	input+16364(%rip), %xmm1, %xmm1
	addl	%r13d, %r11d
	movl	%r11d, output+16372(%rip)
	movl	input+16376(%rip), %r11d
	movl	input+16380(%rip), %r13d
	imull	%eax, %r11d
	imull	%r10d, %r13d
	vpaddd	%xmm1, %xmm0, %xmm0
	addl	output+16376(%rip), %r11d
	addl	%r11d, %r13d
	movl	input+16384(%rip), %r11d
	vpshufd	$0, %xmm5, %xmm1
	imull	%r9d, %r11d
	vmovd	%esi, %xmm7
	vpmulld	input+16368(%rip), %xmm1, %xmm1
	addl	%r11d, %r13d
	movl	%r8d, %r11d
	imull	%ebx, %r11d
	vpaddd	%xmm1, %xmm0, %xmm0
	...
	vmovd	%ecx, %xmm3
	imull	%edi, %r11d
	vpmulld	input+16372(%rip), %xmm1, %xmm1
	vpaddd	%xmm1, %xmm0, %xmm0
	addl	%r11d, %r13d
	movl	%esi, %r11d
	imull	%r14d, %r11d
	...
	movl	%ecx, %r11d
	imull	%r15d, %r11d
	vpmulld	input+16376(%rip), %xmm1, %xmm1
	vpaddd	%xmm1, %xmm0, %xmm0
	addl	%r13d, %r11d
	movl	input+16404(%rip), %r13d
	vpshufd	$0, %xmm3, %xmm1
	imull	%edx, %r13d
	vpmulld	input+16380(%rip), %xmm1, %xmm1
	vpaddd	%xmm1, %xmm0, %xmm0
	addl	%r13d, %r11d
	imull	input+16380(%rip), %eax
	imull	input+16384(%rip), %r10d
	imull	%ebx, %r9d
	imull	input+16392(%rip), %r8d
	addl	output+16380(%rip), %eax
	imull	%r14d, %edi
	addl	%r10d, %eax
	imull	%r15d, %esi
	vpshufd	$0, %xmm4, %xmm1
	addl	%r9d, %eax
	imull	input+16404(%rip), %ecx
	vpmulld	input+16384(%rip), %xmm1, %xmm1
	addl	%r8d, %eax
	vpaddd	%xmm1, %xmm0, %xmm0
	movl	%r11d, output+16376(%rip)
	vmovups	%xmm0, output+16356(%rip)
	addl	%edi, %eax
	imull	input+16408(%rip), %edx
	addl	%esi, %eax
	addl	%ecx, %eax
	addl	%edx, %eax
	movl	%eax, output+16380(%rip)
	rdtsc
	salq	$32, %rdx
	orq	%rdx, %rax
