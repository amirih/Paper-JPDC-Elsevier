...
#NO_APP
	rdtsc
	vmovdqa	coeff_avx(%rip), %ymm9
	vmovdqa	coeff_avx+32(%rip), %ymm8
	vmovdqa	coeff_avx+64(%rip), %ymm7
	vmovdqa	coeff_avx+96(%rip), %ymm6
	vmovdqa	coeff_avx+128(%rip), %ymm5
	salq	$32, %rdx
	orq	%rdx, %rax
	vmovdqa	coeff_avx+160(%rip), %ymm4
	vmovdqa	coeff_avx+192(%rip), %ymm3
	vmovdqa	coeff_avx+224(%rip), %ymm2
	movq	%rax, t1_rdtsc(%rip)
	xorl	%eax, %eax
	.p2align 4,,10
	.p2align 3
.L95:
	vpmulld	input_avx+12(%rax), %ymm6, %ymm1
	vpmulld	input_avx+4(%rax), %ymm8, %ymm10
	vpmulld	input_avx+8(%rax), %ymm7, %ymm0
	vpaddd	%ymm1, %ymm0, %ymm0
	vpmulld	input_avx(%rax), %ymm9, %ymm1
	vpaddd	%ymm10, %ymm1, %ymm1
	vpaddd	%ymm1, %ymm0, %ymm0
	vpmulld	input_avx+20(%rax), %ymm4, %ymm10
	vpmulld	input_avx+16(%rax), %ymm5, %ymm1
	vpaddd	%ymm10, %ymm1, %ymm1
	vpaddd	%ymm1, %ymm0, %ymm0
	vpmulld	input_avx+28(%rax), %ymm2, %ymm10
	vpmulld	input_avx+24(%rax), %ymm3, %ymm1
	vpaddd	%ymm10, %ymm1, %ymm1
	vpaddd	%ymm1, %ymm0, %ymm0
	vmovdqa	%ymm0, output(%rax)
	addq	$32, %rax
	cmpq	$16384, %rax
	jne	.L95
	rdtsc
