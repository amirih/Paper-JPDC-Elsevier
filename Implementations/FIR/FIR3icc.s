...
# mark_description "-D _GNU_SOURCE -O3 -xHOST -no-vec -S -c -o FIR3icc.s";
	.file "FIR3.c"
	.text
..TXTST0:
...
..L2:
	...
	.cfi_offset 6, -16
        andq      $-128, %rsp                                   #27.1
        subq      $128, %rsp                                    #27.1
        movl      $10330110, %esi                               #27.1
        movl      $3, %edi                                      #27.1
        call      __intel_new_feature_proc_init                 #27.1
                                # LOE rbx r12 r13 r14 r15
..B1.23:                        # Preds ..B1.1
                                # Execution count [1.00e+00]
        vstmxcsr  (%rsp)                                        #27.1
        vpxor     %ymm0, %ymm0, %ymm0                           #28.2
        orl       $32832, (%rsp)                                #27.1
        vldmxcsr  (%rsp)                                        #27.1
        vmovdqu   %ymm0, mask(%rip)                             #28.2
        vmovdqu   %ymm0, 32+mask(%rip)                          #28.2
        vmovdqu   %ymm0, 64+mask(%rip)                          #28.2
        vmovdqu   %ymm0, 96+mask(%rip)                          #28.2
                                # LOE rbx r12 r13 r14 r15
..B1.2:                         # Preds ..B1.23
...
..B1.4:                         # Preds ..B1.4 ..B1.3
        ...
        sarl      $31, %edi                                     #29.2
        subl      %edi, %edx                                    #29.2
        imull     $-1000, %edx, %r8d                            #29.2
        addl      %r8d, %r9d                                    #29.2
        movl      %r9d, input_avx(,%rcx,4)                      #29.17
        incq      %rcx                                          #29.2
        cmpq      $4096, %rcx                                   #29.2
        jl        ..B1.4        # Prob 99%                      #29.2
                                # LOE rcx rbx r12 r13 r14 r15 esi
..B1.5:                         # Preds ..B1.4
                                # Execution count [1.72e+00]
        movq      $0x4a817c7ff, %rax                            #34.2
        movq      $.L_2__STRING.8, programName(%rip)            #31.2
        movq      $9999999, elapsed_rdtsc(%rip)                 #34.2
        movq      %rax, overal_time(%rip)                       #34.2
        movq      $0, ttime(%rip)                               #34.2
                                # LOE rbx r12 r13 r14 r15
...
..B1.7:                         # Preds ..B1.25
                                # Execution count [2.91e+00]
        movq      %rax, t1_rdtsc(%rip)                          #34.2
        xorl      %edx, %edx                                    #36.3
        vmovdqu   coeff_avx(%rip), %ymm12                       #39.48
        xorl      %eax, %eax                                    #36.3
        vmovdqu   64+coeff_avx(%rip), %ymm6                     #43.47
        vmovdqu   128+coeff_avx(%rip), %ymm8                    #43.47
        vmovdqu   192+coeff_avx(%rip), %ymm10                   #43.47
        vmovdqu   224+coeff_avx(%rip), %ymm11                   #43.47
        vmovdqu   160+coeff_avx(%rip), %ymm9                    #43.47
        vmovdqu   96+coeff_avx(%rip), %ymm7                     #43.47
        vmovdqu   32+coeff_avx(%rip), %ymm0                     #43.47
                                # LOE rax rbx r12 r13 r14 r15 edx ymm0 ymm6 ymm7 ymm8 ymm9 ymm10 ymm11 ymm12
..B1.8:                         # Preds ..B1.8 ..B1.7
                                # Execution count [1.49e+03]
        vpmulld   4+input_avx(%rax), %ymm0, %ymm14              #44.15
        incl      %edx                                          #36.3
        vpmulld   input_avx(%rax), %ymm12, %ymm15               #40.12
        vpaddd    %ymm15, %ymm14, %ymm14                        #45.14
        vpmulld   8+input_avx(%rax), %ymm6, %ymm13              #44.15
        vpaddd    %ymm14, %ymm13, %ymm13                        #45.14
        vpmulld   12+input_avx(%rax), %ymm7, %ymm1              #44.15
        vpaddd    %ymm13, %ymm1, %ymm1                          #45.14
        vpmulld   16+input_avx(%rax), %ymm8, %ymm2              #44.15
        vpaddd    %ymm1, %ymm2, %ymm2                           #45.14
        vpmulld   20+input_avx(%rax), %ymm9, %ymm3              #44.15
        vpaddd    %ymm2, %ymm3, %ymm3                           #45.14
        vpmulld   24+input_avx(%rax), %ymm10, %ymm4             #44.15
        vpaddd    %ymm3, %ymm4, %ymm4                           #45.14
        vpmulld   28+input_avx(%rax), %ymm11, %ymm5             #44.15
        vpaddd    %ymm4, %ymm5, %ymm5                           #45.14
        vmovdqu   %ymm5, output(%rax)                           #48.35
        addq      $32, %rax                                     #36.3
        cmpl      $512, %edx                                    #36.3
        jb        ..B1.8        # Prob 99%                      #36.3
                                # LOE rax rbx r12 r13 r14 r15 edx ymm0 ymm6 ymm7 ymm8 ymm9 ymm10 ymm11 ymm12
..B1.9:                         # Preds ..B1.8
                                # Execution count [2.91e+00]
        vzeroupper                                              #52.2
...
..B1.27:                        # Preds ..B1.28
                                # Execution count [2.91e+00]
        movq      t2_rdtsc(%rip), %rdx                          #52.2
        subq      t1_rdtsc(%rip), %rdx                          #52.2
        movq      ttbest_rdtsc(%rip), %rsi                      #52.2
        movq      %rdx, ttotal_rdtsc(%rip)                      #52.2
        cmpq      %rsi, %rdx                                    #52.2
        jge       ..B1.12       # Prob 50%                      #52.2
                                # LOE rdx rbx rsi r12 r13 r14 r15
..B1.11:                        # Preds ..B1.27
                                # Execution count [1.45e+00]
        movq      elapsed_rdtsc(%rip), %rcx                     #52.2
        movq      %rcx, %rax                                    #52.2
        negq      %rax                                          #52.2
        movq      %rdx, %rsi                                    #52.2
        addq      $9999999, %rax                                #52.2
        movq      %rdx, ttbest_rdtsc(%rip)                      #52.2
        movq      %rax, elapsed(%rip)                           #52.2
        jmp       ..B1.13       # Prob 100%                     #52.2
...
..B1.13:                        # Preds ..B1.11 ..B1.12
                                # Execution count [2.91e+00]
        movq      ttime(%rip), %rax                             #52.2
        addq      %rdx, %rax                                    #52.2
        movq      %rax, ttime(%rip)                             #52.2
        testq     %rcx, %rcx                                    #52.2
        je        ..B1.16       # Prob 50%                      #52.2
                                # LOE rax rcx rbx rsi r12 r13 r14 r15
..B1.14:                        # Preds ..B1.13
                                # Execution count [1.45e+00]
        decq      %rcx                                          #52.2
        movq      %rcx, elapsed_rdtsc(%rip)                     #52.2
        cmpq      overal_time(%rip), %rax                       #52.2
        jl        ..B1.6        # Prob 82%                      #52.2
        jmp       ..B1.17       # Prob 100%                     #52.2
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.16:                        # Preds ..B1.13
                                # Execution count [1.45e+00]
        movq      $-1, elapsed_rdtsc(%rip)                      #52.2
        movq      $-1, %rcx                                     #52.2
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.17:                        # Preds ..B1.14 ..B1.16
                                # Execution count [1.00e+00]
        negq      %rcx                                          #52.2
        movl      $.L_2__STRING.9, %edi                         #52.2
        addq      $9999999, %rcx                                #52.2
        xorl      %eax, %eax                                    #52.2
        movq      elapsed(%rip), %rdx                           #52.2
..___tag_value_main.8:
...
..B1.18:                        # Preds ..B1.17
                                # Execution count [1.00e+00]
        movl      $.L_2__STRING.10, %edi                        #52.2
        movl      $.L_2__STRING.11, %esi                        #52.2
...
..B1.19:                        # Preds ..B1.18
        ...
        movl      $64, %ecx                                     #52.2
        movq      %rax, %rdi                                    #52.2
        movq      %rax, fileForSpeedups(%rip)                   #52.2
        movl      $.L_2__STRING.12, %esi                        #52.2
        movl      %ecx, %r8d                                    #52.2
        xorl      %eax, %eax                                    #52.2
        movq      programName(%rip), %rdx                       #52.2
        movq      ttbest_rdtsc(%rip), %r9                       #52.2
