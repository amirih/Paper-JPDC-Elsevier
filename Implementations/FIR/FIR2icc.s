...
# mark_description "-D _GNU_SOURCE -O3 -xHOST -no-vec -S -c -o FIR2icc.s";
	.file "FIR2.c"
	.text
..TXTST0:
...
..B1.24:                        # Preds ..B1.1
                                # Execution count [1.00e+00]
        vstmxcsr  (%rsp)                                        #26.1
        vpxor     %ymm0, %ymm0, %ymm0                           #27.2
        orl       $32832, (%rsp)                                #26.1
        vldmxcsr  (%rsp)                                        #26.1
        vmovdqu   %ymm0, mask(%rip)                             #27.2
        vmovdqu   %ymm0, 32+mask(%rip)                          #27.2
        vmovdqu   %ymm0, 64+mask(%rip)                          #27.2
        vmovdqu   %ymm0, 96+mask(%rip)                          #27.2
                                # LOE rbx r12 r13 r14 r15
..B1.2:                         # Preds ..B1.24
...
..B1.3:                         # Preds ..B1.2
        ...
        movl      $1234, %esi                                   #28.2
        xorl      %ecx, %ecx                                    #28.2
                                # LOE rcx rbx r12 r13 r14 r15 esi
..B1.4:                         # Preds ..B1.4 ..B1.3
                                # Execution count [4.10e+03]
        movl      %ecx, %r9d                                    #28.2
        movl      $274877907, %eax                              #28.2
        imull     %esi, %r9d                                    #28.2
        incl      %esi                                          #28.2
        imull     %r9d                                          #28.2
        movl      %r9d, %edi                                    #28.2
        ...
        sarl      $31, %edi                                     #28.2
        subl      %edi, %edx                                    #28.2
        imull     $-1000, %edx, %r8d                            #28.2
        addl      %r8d, %r9d                                    #28.2
        movl      %r9d, input_avx(,%rcx,4)                      #28.17
        incq      %rcx                                          #28.2
        cmpq      $4096, %rcx                                   #28.2
        jl        ..B1.4        # Prob 99%                      #28.2
                                # LOE rcx rbx r12 r13 r14 r15 esi
..B1.5:                         # Preds ..B1.4
                                # Execution count [1.72e+00]
        movq      $0x4a817c7ff, %rax                            #33.2
        movq      $.L_2__STRING.8, programName(%rip)            #30.2
        vpxor     %xmm0, %xmm0, %xmm0                           #35.12
        movq      $9999999, elapsed_rdtsc(%rip)                 #33.2
        movq      %rax, overal_time(%rip)                       #33.2
        movq      $0, ttime(%rip)                               #33.2
                                # LOE rbx r12 r13 r14 r15
...
..B1.7:                         # Preds ..B1.26
                                # Execution count [2.91e+00]
        movq      %rax, t1_rdtsc(%rip)                          #33.2
        xorl      %edx, %edx                                    #34.3
        vmovdqu   coeff_avx(%rip), %xmm12                       #37.44
        vpxor     %xmm14, %xmm14, %xmm14                        #34.3
        vmovdqu   64+coeff_avx(%rip), %xmm9                     #44.44
        xorl      %eax, %eax                                    #34.3
        vmovdqu   96+coeff_avx(%rip), %xmm11                    #44.44
        vmovdqu   80+coeff_avx(%rip), %xmm10                    #44.44
        vmovdqu   48+coeff_avx(%rip), %xmm8                     #44.44
        vmovdqu   32+coeff_avx(%rip), %xmm7                     #44.44
        vmovdqu   16+coeff_avx(%rip), %xmm6                     #44.44
        vmovdqu   112+coeff_avx(%rip), %xmm0                    #44.44
                                # LOE rax rbx r12 r13 r14 r15 edx xmm0 xmm6 xmm7 xmm8 xmm9 xmm10 xmm11 xmm12 xmm14
..B1.8:                         # Preds ..B1.8 ..B1.7
                                # Execution count [2.98e+03]
        vpmulld   input_avx(%rax), %xmm12, %xmm15               #38.13
        incl      %edx                                          #34.3
        vpmulld   4+input_avx(%rax), %xmm6, %xmm13              #45.15
        vpaddd    %xmm14, %xmm15, %xmm15                        #39.13
        vpmulld   8+input_avx(%rax), %xmm7, %xmm1               #45.15
        vpaddd    %xmm15, %xmm13, %xmm13                        #46.14
        vpmulld   12+input_avx(%rax), %xmm8, %xmm2              #45.15
        vpaddd    %xmm13, %xmm1, %xmm1                          #46.14
        vpmulld   16+input_avx(%rax), %xmm9, %xmm3              #45.15
        vpaddd    %xmm1, %xmm2, %xmm2                           #46.14
        vpmulld   20+input_avx(%rax), %xmm10, %xmm4             #45.15
        vpaddd    %xmm2, %xmm3, %xmm3                           #46.14
        vpmulld   24+input_avx(%rax), %xmm11, %xmm5             #45.15
        vpaddd    %xmm3, %xmm4, %xmm4                           #46.14
        vpaddd    %xmm4, %xmm5, %xmm1                           #46.14
        vpmulld   28+input_avx(%rax), %xmm0, %xmm5              #45.15
        vpaddd    %xmm1, %xmm5, %xmm2                           #46.14
        vmovdqu   %xmm2, output(%rax)                           #49.32
        addq      $16, %rax                                     #34.3
        cmpl      $1024, %edx                                   #34.3
        jb        ..B1.8        # Prob 99%                      #34.3
                                # LOE rax rbx r12 r13 r14 r15 edx xmm0 xmm6 xmm7 xmm8 xmm9 xmm10 xmm11 xmm12 xmm14
..B1.9:                         # Preds ..B1.8
                                # Execution count [2.91e+00]
        rdtsc                                                   #53.3
...
..B1.28:                        # Preds ..B1.29
                                # Execution count [2.91e+00]
        movq      t2_rdtsc(%rip), %rdx                          #53.3
        subq      t1_rdtsc(%rip), %rdx                          #53.3
        movq      ttbest_rdtsc(%rip), %rsi                      #53.3
        movq      %rdx, ttotal_rdtsc(%rip)                      #53.3
        cmpq      %rsi, %rdx                                    #53.3
        jge       ..B1.12       # Prob 50%                      #53.3
                                # LOE rdx rbx rsi r12 r13 r14 r15
..B1.11:                        # Preds ..B1.28
                                # Execution count [1.45e+00]
        movq      elapsed_rdtsc(%rip), %rcx                     #53.3
        movq      %rcx, %rax                                    #53.3
        negq      %rax                                          #53.3
        movq      %rdx, %rsi                                    #53.3
        addq      $9999999, %rax                                #53.3
        movq      %rdx, ttbest_rdtsc(%rip)                      #53.3
        movq      %rax, elapsed(%rip)                           #53.3
        jmp       ..B1.13       # Prob 100%                     #53.3
...
..B1.13:                        # Preds ..B1.11 ..B1.12
                                # Execution count [2.91e+00]
        movq      ttime(%rip), %rax                             #53.3
        addq      %rdx, %rax                                    #53.3
        movq      %rax, ttime(%rip)                             #53.3
        testq     %rcx, %rcx                                    #53.3
        je        ..B1.16       # Prob 50%                      #53.3
                                # LOE rax rcx rbx rsi r12 r13 r14 r15
..B1.14:                        # Preds ..B1.13
                                # Execution count [1.45e+00]
        decq      %rcx                                          #53.3
        movq      %rcx, elapsed_rdtsc(%rip)                     #53.3
        cmpq      overal_time(%rip), %rax                       #53.3
        jl        ..B1.6        # Prob 82%                      #53.3
        jmp       ..B1.17       # Prob 100%                     #53.3
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.16:                        # Preds ..B1.13
                                # Execution count [1.45e+00]
        movq      $-1, elapsed_rdtsc(%rip)                      #53.3
        movq      $-1, %rcx                                     #53.3
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.17:                        # Preds ..B1.14 ..B1.16
                                # Execution count [1.00e+00]
        negq      %rcx                                          #53.3
        movl      $.L_2__STRING.9, %edi                         #53.3
        addq      $9999999, %rcx                                #53.3
        xorl      %eax, %eax                                    #53.3
        movq      elapsed(%rip), %rdx                           #53.3
..___tag_value_main.8:
...
..B1.18:                        # Preds ..B1.17
                                # Execution count [1.00e+00]
        movl      $.L_2__STRING.10, %edi                        #53.3
        movl      $.L_2__STRING.11, %esi                        #53.3
...
..B1.19:                        # Preds ..B1.18
        ...
        movl      $64, %ecx                                     #53.3
        movq      %rax, %rdi                                    #53.3
        movq      %rax, fileForSpeedups(%rip)                   #53.3
        movl      $.L_2__STRING.12, %esi                        #53.3
        movl      %ecx, %r8d                                    #53.3
        xorl      %eax, %eax                                    #53.3
        movq      programName(%rip), %rdx                       #53.3
        movq      ttbest_rdtsc(%rip), %r9                       #53.3
#       fprintf(FILE *__restrict__, const char *__restrict__, ...)
        call      fprintf                                       #53.3
                                # LOE rbx r12 r13 r14 r15
..B1.20:                        # Preds ..B1.19
                                # Execution count [1.00e+00]
        movl      $.L_2__STRING.13, %edi                        #54.3
        xorl      %eax, %eax                                    #54.3
        movl      128+output(%rip), %esi                        #54.3
