...
.LFB5559:
	...
	vmovdqa	.LC11(%rip), %ymm10
	vmovdqa	.LC12(%rip), %ymm11
	vmovdqa	.LC13(%rip), %ymm12
	movl	$a, %eax
	xorl	%edx, %edx
.L114:
	vmovd	%edx, %xmm3
	vpbroadcastd	%xmm3, %ymm3
	vpmulld	%ymm5, %ymm3, %ymm13
	incl	%edx
	addq	$256, %rax
	vpsrlq	$32, %ymm13, %ymm14
	vpmuldq	%ymm0, %ymm13, %ymm4
	vpmuldq	%ymm0, %ymm14, %ymm14
	...
	vpslld	$3, %ymm4, %ymm4
	vpsubd	%ymm4, %ymm13, %ymm4
	vpmulld	%ymm6, %ymm3, %ymm13
...
.L118:
	...
	addq	$256, %rax
	vpmulld	-256(%rax), %ymm0, %ymm0
	addq	$4, %rdx
	vpaddd	%ymm0, %ymm1, %ymm1
	cmpq	%rcx, %rax
	jne	.L118
	addq	$32, %rdi
	vmovdqa	%ymm1, -16384(%rsi,%rax)
	leaq	32(%rax), %rcx
	cmpq	$b+256, %rdi
	jne	.L121
	addq	$256, %rsi
