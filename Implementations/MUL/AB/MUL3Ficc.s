...
# mark_description "-D _GNU_SOURCE -O3 -xHOST -S -c -no-vec -o MUL3Ficc.s";
	.file "MUL3F.c"
	.text
..TXTST0:
...
..B1.34:                        # Preds ..B1.1
                                # Execution count [1.00e+00]
        vstmxcsr  (%rsp)                                        #7.1
        vpxor     %ymm0, %ymm0, %ymm0                           #8.2
        orl       $32832, (%rsp)                                #7.1
        vldmxcsr  (%rsp)                                        #7.1
        vmovdqu   %ymm0, mask(%rip)                             #8.2
        vmovdqu   %ymm0, 32+mask(%rip)                          #8.2
        vmovdqu   %ymm0, 64+mask(%rip)                          #8.2
        vmovdqu   %ymm0, 96+mask(%rip)                          #8.2
                                # LOE rbx r12 r13 r14 r15
..B1.2:                         # Preds ..B1.34
...
#       sched_setaffinity(__pid_t, size_t, const cpu_set_t *)
        call      sched_setaffinity                             #8.2
..___tag_value_main.7:
                                # LOE rbx r12 r13 r14 r15
..B1.3:                         # Preds ..B1.2
                                # Execution count [1.00e+00]
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm0             #9.2
        xorl      %r9d, %r9d                                    #9.2
        xorl      %ecx, %ecx                                    #9.2
...
..B1.5:                         # Preds ..B1.5 ..B1.4
                                # Execution count [4.19e+06]
        incl      %edi                                          #9.2
        movl      %r9d, %eax                                    #9.2
        xorl      %edx, %edx                                    #9.2
        vxorpd    %xmm1, %xmm1, %xmm1                           #9.2
        idivl     %edi                                          #9.2
        movl      %eax, %esi                                    #9.2
        movl      $274877907, %eax                              #9.2
        addl      %r10d, %esi                                   #9.2
        addl      %r9d, %r10d                                   #9.2
        imull     %esi                                          #9.2
        movl      %esi, %r11d                                   #9.2
        ...
        sarl      $31, %r11d                                    #9.2
        subl      %r11d, %edx                                   #9.2
        imull     $-1000, %edx, %eax                            #9.2
        addl      %eax, %esi                                    #9.2
        vcvtsi2sd %esi, %xmm1, %xmm1                            #9.2
        vaddsd    %xmm1, %xmm0, %xmm2                           #9.2
        vcvtsd2ss %xmm2, %xmm2, %xmm2                           #9.2
        vmovss    %xmm2, a(%r8)                                 #9.2
        addq      $4, %r8                                       #9.2
        cmpl      $2048, %edi                                   #9.2
        jl        ..B1.5        # Prob 99%                      #9.2
                                # LOE rcx rbx r8 r12 r13 r14 r15 edi r9d r10d xmm0
...
..B1.7:                         # Preds ..B1.6
        ...
        xorl      %r8d, %r8d                                    #10.2
        xorl      %r9d, %r9d                                    #10.2
                                # LOE rbx r9 r12 r13 r14 r15 r8d xmm0
..B1.8:                         # Preds ..B1.10 ..B1.7
        ...
        xorl      %r10d, %r10d                                  #10.2
        .align    16,0x90
                                # LOE rbx rdi r9 r12 r13 r14 r15 esi r8d r10d xmm0
..B1.9:                         # Preds ..B1.9 ..B1.8
                                # Execution count [4.19e+06]
        incl      %esi                                          #10.2
        movl      %r8d, %eax                                    #10.2
        xorl      %edx, %edx                                    #10.2
        vxorpd    %xmm1, %xmm1, %xmm1                           #10.2
        idivl     %esi                                          #10.2
        movl      %eax, %ecx                                    #10.2
        movl      $274877907, %eax                              #10.2
        addl      %r10d, %ecx                                   #10.2
        addl      %r8d, %r10d                                   #10.2
        imull     %ecx                                          #10.2
        movl      %ecx, %r11d                                   #10.2
        ...
        sarl      $31, %r11d                                    #10.2
        subl      %r11d, %edx                                   #10.2
        imull     $-1000, %edx, %eax                            #10.2
        addl      %eax, %ecx                                    #10.2
        vcvtsi2sd %ecx, %xmm1, %xmm1                            #10.2
        vaddsd    %xmm1, %xmm0, %xmm2                           #10.2
        vcvtsd2ss %xmm2, %xmm2, %xmm2                           #10.2
        vmovss    %xmm2, b(%rdi)                                #10.2
        addq      $4, %rdi                                      #10.2
        cmpl      $2048, %esi                                   #10.2
        jl        ..B1.9        # Prob 99%                      #10.2
                                # LOE rbx rdi r9 r12 r13 r14 r15 esi r8d r10d xmm0
..B1.10:                        # Preds ..B1.9
                                # Execution count [2.05e+03]
        incl      %r8d                                          #10.2
        addq      $8192, %r9                                    #10.2
        cmpl      $2048, %r8d                                   #10.2
        jl        ..B1.8        # Prob 99%                      #10.2
                                # LOE rbx r9 r12 r13 r14 r15 r8d xmm0
..B1.11:                        # Preds ..B1.10
                                # Execution count [1.00e+00]
        vmovups   vindexm.379.0.0.16(%rip), %ymm2               #15.17
        movq      $.L_2__STRING.8, programName(%rip)            #11.2
                                # LOE rbx r12 r13 r14 r15 ymm2
..B1.12:                        # Preds ..B1.11
                                # Execution count [1.72e+00]
        movq      $0xe8d4a50fff, %rax                           #20.2
        movq      $9, elapsed_rdtsc(%rip)                       #20.2
        movq      %rax, overal_time(%rip)                       #20.2
        movq      $0, ttime(%rip)                               #20.2
        vxorps    %ymm1, %ymm1, %ymm1                           #23.13
        vpcmpeqd  %ymm0, %ymm0, %ymm0                           #25.78
                                # LOE rbx r12 r13 r14 r15
...
..B1.14:                        # Preds ..B1.36
        ...
        xorl      %edx, %edx                                    #21.7
        vpcmpeqd  %ymm0, %ymm0, %ymm0                           #21.7
        xorl      %eax, %eax                                    #21.7
        vxorps    %ymm1, %ymm1, %ymm1                           #21.7
        vmovups   vindexm.379.0.0.16(%rip), %ymm2               #21.7
                                # LOE rax rbx r12 r13 r14 r15 edx ymm0 ymm1 ymm2
..B1.15:                        # Preds ..B1.19 ..B1.14
                                # Execution count [5.95e+03]
        xorl      %esi, %esi                                    #22.7
        movq      %rax, %rcx                                    #25.67
                                # LOE rax rcx rbx rsi r12 r13 r14 r15 edx ymm0 ymm1 ymm2
..B1.16:                        # Preds ..B1.18 ..B1.15
                                # Execution count [1.22e+07]
        vmovaps   %ymm1, %ymm3                                  #23.13
        xorl      %r8d, %r8d                                    #24.8
        lea       b(,%rsi,4), %rdi                              #25.100
                                # LOE rax rcx rbx rsi rdi r8 r12 r13 r14 r15 edx ymm0 ymm1 ymm2 ymm3
..B1.17:                        # Preds ..B1.17 ..B1.16
                                # Execution count [3.12e+09]
        vmovdqa   %ymm0, %ymm4                                  #25.78
        vxorps    %ymm5, %ymm5, %ymm5                           #25.78
        vgatherdps %ymm4, (%rdi,%ymm2,4), %ymm5                 #25.78
        addq      $65536, %rdi                                  #24.19
        vmulps    a(%rax,%r8,4), %ymm5, %ymm6                   #25.14
        addq      $8, %r8                                       #24.19
        vaddps    %ymm3, %ymm6, %ymm3                           #25.14
        cmpq      $2048, %r8                                    #24.14
        jl        ..B1.17       # Prob 99%                      #24.14
                                # LOE rax rcx rbx rsi rdi r8 r12 r13 r14 r15 edx ymm0 ymm1 ymm2 ymm3
..B1.18:                        # Preds ..B1.17
                                # Execution count [1.22e+07]
        vmovups   %ymm3, (%rsp)                                 #27.21
        incq      %rsi                                          #22.18
        vmovss    (%rsp), %xmm3                                 #28.21
        vmovss    8(%rsp), %xmm4                                #28.39
        vmovss    16(%rsp), %xmm7                               #28.57
        vmovss    24(%rsp), %xmm8                               #28.75
        vaddss    4(%rsp), %xmm3, %xmm5                         #28.4
        vaddss    12(%rsp), %xmm4, %xmm6                        #28.4
        vaddss    20(%rsp), %xmm7, %xmm9                        #28.4
        vaddss    28(%rsp), %xmm8, %xmm10                       #28.4
        vaddss    %xmm6, %xmm5, %xmm11                          #28.4
        vaddss    %xmm10, %xmm9, %xmm12                         #28.4
        vaddss    %xmm12, %xmm11, %xmm13                        #28.4
        vmovss    %xmm13, c_result(%rcx)                        #28.4
        addq      $4, %rcx                                      #22.18
        cmpq      $2048, %rsi                                   #22.13
        jl        ..B1.16       # Prob 99%                      #22.13
                                # LOE rax rcx rbx rsi r12 r13 r14 r15 edx ymm0 ymm1 ymm2
..B1.19:                        # Preds ..B1.18
                                # Execution count [5.95e+03]
        incl      %edx                                          #21.18
...
..B1.38:                        # Preds ..B1.39
                                # Execution count [2.91e+00]
        movq      t2_rdtsc(%rip), %rdx                          #32.2
        subq      t1_rdtsc(%rip), %rdx                          #32.2
        movq      ttbest_rdtsc(%rip), %rsi                      #32.2
        movq      %rdx, ttotal_rdtsc(%rip)                      #32.2
        cmpq      %rsi, %rdx                                    #32.2
        jge       ..B1.23       # Prob 50%                      #32.2
                                # LOE rdx rbx rsi r12 r13 r14 r15
..B1.22:                        # Preds ..B1.38
                                # Execution count [1.45e+00]
        movq      elapsed_rdtsc(%rip), %rcx                     #32.2
        movq      %rcx, %rax                                    #32.2
        negq      %rax                                          #32.2
        movq      %rdx, %rsi                                    #32.2
        addq      $9, %rax                                      #32.2
        movq      %rdx, ttbest_rdtsc(%rip)                      #32.2
        movq      %rax, elapsed(%rip)                           #32.2
        jmp       ..B1.24       # Prob 100%                     #32.2
...
..B1.24:                        # Preds ..B1.22 ..B1.23
                                # Execution count [2.91e+00]
        movq      ttime(%rip), %rax                             #32.2
        addq      %rdx, %rax                                    #32.2
        movq      %rax, ttime(%rip)                             #32.2
        testq     %rcx, %rcx                                    #32.2
        je        ..B1.27       # Prob 50%                      #32.2
                                # LOE rax rcx rbx rsi r12 r13 r14 r15
..B1.25:                        # Preds ..B1.24
                                # Execution count [1.45e+00]
        decq      %rcx                                          #32.2
        movq      %rcx, elapsed_rdtsc(%rip)                     #32.2
        cmpq      overal_time(%rip), %rax                       #32.2
        jl        ..B1.13       # Prob 82%                      #32.2
        jmp       ..B1.28       # Prob 100%                     #32.2
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.27:                        # Preds ..B1.24
                                # Execution count [1.45e+00]
        movq      $-1, elapsed_rdtsc(%rip)                      #32.2
        movq      $-1, %rcx                                     #32.2
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.28:                        # Preds ..B1.25 ..B1.27
                                # Execution count [1.00e+00]
        negq      %rcx                                          #32.2
        movl      $.L_2__STRING.9, %edi                         #32.2
        addq      $9, %rcx                                      #32.2
        xorl      %eax, %eax                                    #32.2
        movq      elapsed(%rip), %rdx                           #32.2
..___tag_value_main.8:
...
..B1.29:                        # Preds ..B1.28
                                # Execution count [1.00e+00]
        movl      $.L_2__STRING.10, %edi                        #32.2
        movl      $.L_2__STRING.11, %esi                        #32.2
...
..B1.30:                        # Preds ..B1.29
        ...
        movl      $2048, %ecx                                   #32.2
        movq      %rax, %rdi                                    #32.2
        movq      %rax, fileForSpeedups(%rip)                   #32.2
        movl      $.L_2__STRING.12, %esi                        #32.2
        movl      %ecx, %r8d                                    #32.2
        xorl      %eax, %eax                                    #32.2
        movq      programName(%rip), %rdx                       #32.2
        movq      ttbest_rdtsc(%rip), %r9                       #32.2
...
..B6.3:                         # Preds ..B6.3 ..B6.2
        ...
        incq      %rsi                                          #106.20
        cmpq      $2048, %rsi                                   #106.14
        jl        ..B6.3        # Prob 99%                      #106.14
                                # LOE rbx rbp rsi rdi r12 r13 r14 r15 ecx
..B6.4:                         # Preds ..B6.3
                                # Execution count [2.05e+03]
        incl      %ecx                                          #105.19
        addq      $8192, %rdi                                   #105.19
        cmpl      $2048, %ecx                                   #105.13
        jl        ..B6.2        # Prob 99%                      #105.13
                                # LOE rbx rbp rdi r12 r13 r14 r15 ecx
..B6.5:                         # Preds ..B6.4
                                # Execution count [1.00e+00]
        ret                                                     #113.1
...
..B7.4:                         # Preds ..B7.9
        ...
        incq      %r14                                          #119.20
        cmpq      $2048, %r14                                   #119.14
        jl        ..B7.3        # Prob 99%                      #119.14
                                # LOE rbx rbp r13 r14 r15 r12d
..B7.5:                         # Preds ..B7.4
                                # Execution count [2.05e+03]
        incl      %r12d                                         #118.19
        addq      $4096, %r13                                   #118.19
        cmpl      $2048, %r12d                                  #118.13
        jl        ..B7.2        # Prob 99%                      #118.13
                                # LOE rbx rbp r13 r15 r12d
..B7.6:                         # Preds ..B7.5
                                # Execution count [1.00e+00]
	.cfi_restore 14
...
..B8.4:                         # Preds ..B8.9
        ...
        incq      %r14                                          #131.20
        cmpq      $2048, %r14                                   #131.14
        jl        ..B8.3        # Prob 99%                      #131.14
                                # LOE rbx rbp r13 r14 r15 r12d
..B8.5:                         # Preds ..B8.4
                                # Execution count [2.05e+03]
        incl      %r12d                                         #130.19
        addq      $4096, %r13                                   #130.19
        cmpl      $2048, %r12d                                  #130.13
        jl        ..B8.2        # Prob 99%                      #130.13
                                # LOE rbx rbp r13 r15 r12d
..B8.6:                         # Preds ..B8.5
                                # Execution count [1.00e+00]
	.cfi_restore 14
...
..B9.8:                         # Preds ..B9.7
        ...
        imulq     $8204, %r8, %r10                              #146.14
        addq      %rdi, %r10                                    #146.14
        lea       (%rdi,%r8,4), %rbp                            #145.11
        movl      -4(%rbp,%rax), %r9d                           #145.11
        movl      -8204(%r10,%rcx,4), %ebx                      #146.14
        movl      %ebx, -4(%rbp,%rax)                           #146.4
        movl      %r9d, -8204(%r10,%rcx,4)                      #147.4
                                # LOE rax rdx rcx rdi r12 r13 r14 esi
...
# --- assignMatrixui16(unsigned short (*)[2048])
assignMatrixui16:
# parameter 1: %rdi
..B10.1:                        # Preds ..B10.0
                                # Execution count [1.00e+00]
...
..B10.3:                        # Preds ..B10.3 ..B10.2
        ...
        movzbl    %cl, %ecx                                     #159.25
        movw      %cx, (%rdi,%rdx,2)                            #159.4
        incq      %rdx                                          #155.20
        cmpq      $2048, %rdx                                   #155.14
        jl        ..B10.3       # Prob 99%                      #155.14
                                # LOE rdx rbx rbp rdi r12 r13 r14 r15 eax
..B10.4:                        # Preds ..B10.3
                                # Execution count [2.05e+03]
        incl      %eax                                          #154.19
        addq      $4096, %rdi                                   #154.19
        cmpl      $2048, %eax                                   #154.13
        jl        ..B10.2       # Prob 99%                      #154.13
                                # LOE rbx rbp rdi r12 r13 r14 r15 eax
..B10.5:                        # Preds ..B10.4
                                # Execution count [1.00e+00]
        ret                                                     #162.1
...
# --- assignMatrixi8(unsigned char (*)[2048])
assignMatrixi8:
# parameter 1: %rdi
..B11.1:                        # Preds ..B11.0
                                # Execution count [1.00e+00]
...
..B11.11:                       # Preds ..B11.9 ..B11.12
        ...
        incq      %r14                                          #168.20
        cmpq      $2048, %r14                                   #168.14
        jl        ..B11.3       # Prob 99%                      #168.14
                                # LOE rbx rbp r13 r14 r15 r12d
..B11.5:                        # Preds ..B11.11
                                # Execution count [2.05e+03]
        incl      %r12d                                         #167.19
        addq      $2048, %r13                                   #167.19
        cmpl      $2048, %r12d                                  #167.13
        jl        ..B11.2       # Prob 99%                      #167.13
                                # LOE rbx rbp r13 r15 r12d
..B11.6:                        # Preds ..B11.5
                                # Execution count [1.00e+00]
	.cfi_restore 14
...
..B12.2:                        # Preds ..B12.2 ..B12.1
        ...
        incq      %rcx                                          #180.25
        cmpq      $4194304, %rcx                                #180.14
        jl        ..B12.2       # Prob 99%                      #180.14
                                # LOE rcx rbx rbp rdi r12 r13 r14 r15 esi
..B12.3:                        # Preds ..B12.2
                                # Execution count [2.29e-01]
        ret                                                     #189.1
        .align    16,0x90
                                # LOE
	.cfi_endproc
...
# --- savefloatMatrixFileForOutPuts(float (*)[2048])
...
..B13.7:                        # Preds ..B13.6
                                # Execution count [4.19e+06]
        incq      %r15                                          #500.21
        cmpq      $2048, %r15                                   #500.15
        jl        ..B13.6       # Prob 99%                      #500.15
                                # LOE rbx rbp r12 r14 r15 r13d
..B13.8:                        # Preds ..B13.7
                                # Execution count [2.05e+03]
        incl      %r13d                                         #498.23
        addq      $8192, %r14                                   #498.23
        cmpl      $2048, %r13d                                  #498.17
        jl        ..B13.4       # Prob 99%                      #498.17
                                # LOE rbx rbp r12 r14 r13d
..B13.9:                        # Preds ..B13.8
                                # Execution count [1.00e+00]
...
# --- savefloatMatrixFileName(float (*)[2048], char *)
...
..B14.7:                        # Preds ..B14.6
                                # Execution count [4.19e+06]
        incq      %r15                                          #515.21
        cmpq      $2048, %r15                                   #515.15
        jl        ..B14.6       # Prob 99%                      #515.15
                                # LOE rbx rbp r12 r14 r15 r13d
..B14.8:                        # Preds ..B14.7
                                # Execution count [2.05e+03]
        incl      %r13d                                         #513.23
        addq      $8192, %r14                                   #513.23
        cmpl      $2048, %r13d                                  #513.17
        jl        ..B14.4       # Prob 99%                      #513.17
                                # LOE rbx rbp r12 r14 r13d
..B14.9:                        # Preds ..B14.8
                                # Execution count [1.00e+00]
...
# --- saveintMatrixFileForOutPuts(int (*)[2048])
...
..B15.7:                        # Preds ..B15.6
                                # Execution count [4.19e+06]
        incq      %r13                                          #530.21
        cmpq      $2048, %r13                                   #530.15
        jl        ..B15.6       # Prob 99%                      #530.15
                                # LOE rbx rbp r12 r13 r15 r14d
..B15.8:                        # Preds ..B15.7
                                # Execution count [2.05e+03]
        incl      %r14d                                         #528.23
        addq      $8192, %r15                                   #528.23
        cmpl      $2048, %r14d                                  #528.17
        jl        ..B15.4       # Prob 99%                      #528.17
                                # LOE rbx rbp r12 r15 r14d
..B15.9:                        # Preds ..B15.8
                                # Execution count [1.00e+00]
...
# --- saveintMatrixFileName(int (*)[2048], char *)
...
..B16.7:                        # Preds ..B16.6
                                # Execution count [4.19e+06]
        incq      %r13                                          #544.21
        cmpq      $2048, %r13                                   #544.15
        jl        ..B16.6       # Prob 99%                      #544.15
                                # LOE rbx rbp r12 r13 r15 r14d
..B16.8:                        # Preds ..B16.7
                                # Execution count [2.05e+03]
        incl      %r14d                                         #542.23
        addq      $8192, %r15                                   #542.23
        cmpl      $2048, %r14d                                  #542.17
        jl        ..B16.4       # Prob 99%                      #542.17
                                # LOE rbx rbp r12 r15 r14d
..B16.9:                        # Preds ..B16.8
                                # Execution count [1.00e+00]
