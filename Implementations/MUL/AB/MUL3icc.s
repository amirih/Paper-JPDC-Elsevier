...
# mark_description "-D _GNU_SOURCE -O3 -xHOST -no-vec -S -c -o MUL3icc.s";
	.file "MUL3.c"
	.text
..TXTST0:
...
..B1.3:                         # Preds ..B1.2
        ...
        xorl      %ecx, %ecx                                    #9.2
        xorl      %esi, %esi                                    #9.2
                                # LOE rbx rsi r12 r13 r14 r15 ecx
...
..B1.9:                         # Preds ..B1.9 ..B1.8
        ...
        imull     %r10d                                         #10.2
        sarl      $6, %edx                                      #10.2
        imull     $-1000, %edx, %r9d                            #10.2
        addl      %r9d, %r10d                                   #10.2
        movl      %r10d, b(%rdi)                                #10.2
        addq      $4, %rdi                                      #10.2
        cmpl      $64, %r8d                                     #10.2
        jl        ..B1.9        # Prob 98%                      #10.2
                                # LOE rbx rsi rdi r12 r13 r14 r15 ecx r8d
..B1.10:                        # Preds ..B1.9
                                # Execution count [6.40e+01]
        incl      %ecx                                          #10.2
        addq      $256, %rsi                                    #10.2
        cmpl      $64, %ecx                                     #10.2
        jl        ..B1.8        # Prob 98%                      #10.2
                                # LOE rbx rsi r12 r13 r14 r15 ecx
..B1.11:                        # Preds ..B1.10
                                # Execution count [1.00e+00]
        vmovups   vindexm.379.0.0.16(%rip), %ymm1               #15.17
        movq      $.L_2__STRING.8, programName(%rip)            #11.2
                                # LOE rbx r12 r13 r14 r15 ymm1
..B1.12:                        # Preds ..B1.11
                                # Execution count [1.72e+00]
        movq      $0x4a817c7ff, %rax                            #21.2
        movq      $9999999, elapsed_rdtsc(%rip)                 #21.2
        movq      %rax, overal_time(%rip)                       #21.2
        movq      $0, ttime(%rip)                               #21.2
        vpcmpeqd  %ymm0, %ymm0, %ymm0                           #30.7
                                # LOE
..B1.13:                        # Preds ..B1.23 ..B1.12
...
..B1.14:                        # Preds ..B1.34
                                # Execution count [2.91e+00]
        movq      %rax, t1_rdtsc(%rip)                          #21.2
        xorb      %al, %al                                      #22.3
        vpcmpeqd  %ymm11, %ymm11, %ymm11                        #22.3
        xorl      %edx, %edx                                    #22.3
        vmovups   vindexm.379.0.0.16(%rip), %ymm12              #22.3
        vpxor     %ymm13, %ymm13, %ymm13                        #22.3
                                # LOE rdx al ymm11 ymm12 ymm13
..B1.15:                        # Preds ..B1.17 ..B1.14
                                # Execution count [1.86e+02]
        vmovdqu   a(%rdx), %ymm10                               #29.36
        xorb      %r8b, %r8b                                    #23.4
        vmovdqu   32+a(%rdx), %ymm9                             #29.36
        vmovdqu   64+a(%rdx), %ymm8                             #29.36
        vmovdqu   96+a(%rdx), %ymm7                             #29.36
        vmovdqu   128+a(%rdx), %ymm6                            #29.36
        vmovdqu   160+a(%rdx), %ymm5                            #29.36
        vmovdqu   192+a(%rdx), %ymm4                            #29.36
        vmovdqu   224+a(%rdx), %ymm3                            #29.36
        movb      %al, (%rsp)                                   #29.36[spill]
        xorl      %edi, %edi                                    #23.4
        movl      $b+2048, %esi                                 #30.45
        movl      $b+4096, %ebx                                 #30.45
        movl      $b+6144, %ecx                                 #30.45
        movl      $b+8192, %r10d                                #30.45
        movl      $b+10240, %r11d                               #30.45
        movl      $b+12288, %r12d                               #30.45
        movl      $b+14336, %r13d                               #30.45
        movq      %rdx, %r9                                     #29.36
                                # LOE rdx rcx rbx rsi rdi r9 r10 r11 r12 r13 r8b ymm3 ymm4 ymm5 ymm6 ymm7 ymm8 ymm9 ymm10 ymm11 ymm12 ymm13
..B1.16:                        # Preds ..B1.16 ..B1.15
                                # Execution count [1.19e+04]
        vmovdqa   %ymm11, %ymm14                                #30.7
        incb      %r8b                                          #23.4
        vpxor     %ymm15, %ymm15, %ymm15                        #30.7
        vpxor     %ymm2, %ymm2, %ymm2                           #30.7
        vpgatherdd %ymm14, b(%rdi,%ymm12,4), %ymm15             #30.7
        vmovdqa   %ymm11, %ymm0                                 #30.7
        addq      $4, %rdi                                      #23.4
        vpgatherdd %ymm0, (%rsi,%ymm12,4), %ymm2                #30.7
        addq      $4, %rsi                                      #23.4
        vpmulld   %ymm15, %ymm10, %ymm1                         #28.13
        vpaddd    %ymm1, %ymm13, %ymm14                         #27.15
        vpxor     %ymm1, %ymm1, %ymm1                           #30.7
        vpmulld   %ymm2, %ymm9, %ymm15                          #28.13
        vpaddd    %ymm15, %ymm14, %ymm2                         #27.15
        vpxor     %ymm15, %ymm15, %ymm15                        #30.7
        vmovdqa   %ymm11, %ymm0                                 #30.7
        vpgatherdd %ymm0, (%rbx,%ymm12,4), %ymm1                #30.7
        addq      $4, %rbx                                      #23.4
        vmovdqa   %ymm11, %ymm0                                 #30.7
        vpgatherdd %ymm0, (%rcx,%ymm12,4), %ymm15               #30.7
        addq      $4, %rcx                                      #23.4
        vpmulld   %ymm15, %ymm7, %ymm0                          #28.13
        vpxor     %ymm15, %ymm15, %ymm15                        #30.7
        vpmulld   %ymm1, %ymm8, %ymm14                          #28.13
        vpaddd    %ymm14, %ymm2, %ymm2                          #27.15
        vmovdqa   %ymm11, %ymm14                                #30.7
        vpgatherdd %ymm14, (%r10,%ymm12,4), %ymm15              #30.7
        addq      $4, %r10                                      #23.4
        vpxor     %ymm14, %ymm14, %ymm14                        #30.7
        vpaddd    %ymm0, %ymm2, %ymm1                           #27.15
        vmovdqa   %ymm11, %ymm0                                 #30.7
        vpgatherdd %ymm0, (%r11,%ymm12,4), %ymm14               #30.7
        addq      $4, %r11                                      #23.4
        vpmulld   %ymm14, %ymm5, %ymm0                          #28.13
        vpxor     %ymm14, %ymm14, %ymm14                        #30.7
        vpmulld   %ymm15, %ymm6, %ymm2                          #28.13
        vpaddd    %ymm2, %ymm1, %ymm1                           #27.15
        vmovdqa   %ymm11, %ymm2                                 #30.7
        vpgatherdd %ymm2, (%r12,%ymm12,4), %ymm14               #30.7
        addq      $4, %r12                                      #23.4
        vpxor     %ymm2, %ymm2, %ymm2                           #30.7
        vpaddd    %ymm0, %ymm1, %ymm0                           #27.15
        vmovdqa   %ymm11, %ymm15                                #30.7
        vpgatherdd %ymm15, (%r13,%ymm12,4), %ymm2               #30.7
        addq      $4, %r13                                      #23.4
        vpmulld   %ymm14, %ymm4, %ymm1                          #28.13
        vpaddd    %ymm1, %ymm0, %ymm0                           #27.15
        vpmulld   %ymm2, %ymm3, %ymm1                           #28.13
        vpaddd    %ymm1, %ymm0, %ymm14                          #27.15
        vmovdqu   %ymm14, 32(%rsp)                              #38.36
        movl      32(%rsp), %eax                                #39.21
        movl      40(%rsp), %r14d                               #39.39
        addl      36(%rsp), %eax                                #39.30
        addl      44(%rsp), %r14d                               #39.39
        movl      56(%rsp), %r15d                               #39.75
        addl      %r14d, %eax                                   #39.48
        movl      48(%rsp), %r14d                               #39.57
        addl      52(%rsp), %r14d                               #39.57
        addl      60(%rsp), %r15d                               #39.75
        addl      %r15d, %r14d                                  #39.66
        addl      %r14d, %eax                                   #39.84
        .byte     144                                           #39.5
        movl      %eax, c_result(%r9)                           #39.5
        addq      $4, %r9                                       #23.4
        cmpb      $64, %r8b                                     #23.4
        jb        ..B1.16       # Prob 98%                      #23.4
                                # LOE rdx rcx rbx rsi rdi r9 r10 r11 r12 r13 r8b ymm3 ymm4 ymm5 ymm6 ymm7 ymm8 ymm9 ymm10 ymm11 ymm12 ymm13
..B1.17:                        # Preds ..B1.16
                                # Execution count [1.86e+02]
        movb      (%rsp), %al                                   #[spill]
...
..B1.36:                        # Preds ..B1.37
                                # Execution count [2.91e+00]
        movq      t2_rdtsc(%rip), %rdx                          #44.3
        subq      t1_rdtsc(%rip), %rdx                          #44.3
        movq      ttbest_rdtsc(%rip), %rsi                      #44.3
        movq      %rdx, ttotal_rdtsc(%rip)                      #44.3
        cmpq      %rsi, %rdx                                    #44.3
        jge       ..B1.21       # Prob 50%                      #44.3
                                # LOE rdx rsi
..B1.20:                        # Preds ..B1.36
                                # Execution count [1.45e+00]
        movq      elapsed_rdtsc(%rip), %rcx                     #44.3
        movq      %rcx, %rax                                    #44.3
        negq      %rax                                          #44.3
        movq      %rdx, %rsi                                    #44.3
        addq      $9999999, %rax                                #44.3
        movq      %rdx, ttbest_rdtsc(%rip)                      #44.3
        movq      %rax, elapsed(%rip)                           #44.3
        jmp       ..B1.22       # Prob 100%                     #44.3
                                # LOE rdx rcx rsi
..B1.21:                        # Preds ..B1.36
                                # Execution count [1.45e+00]
        movq      elapsed_rdtsc(%rip), %rcx                     #44.3
...
..B1.22:                        # Preds ..B1.20 ..B1.21
                                # Execution count [2.91e+00]
        movq      ttime(%rip), %rax                             #44.3
        addq      %rdx, %rax                                    #44.3
        movq      %rax, ttime(%rip)                             #44.3
        testq     %rcx, %rcx                                    #44.3
        je        ..B1.25       # Prob 50%                      #44.3
                                # LOE rax rcx rsi
..B1.23:                        # Preds ..B1.22
                                # Execution count [1.45e+00]
        decq      %rcx                                          #44.3
        movq      %rcx, elapsed_rdtsc(%rip)                     #44.3
        cmpq      overal_time(%rip), %rax                       #44.3
        jl        ..B1.13       # Prob 82%                      #44.3
        jmp       ..B1.26       # Prob 100%                     #44.3
                                # LOE rcx rsi
..B1.25:                        # Preds ..B1.22
                                # Execution count [1.45e+00]
        movq      $-1, elapsed_rdtsc(%rip)                      #44.3
        movq      $-1, %rcx                                     #44.3
                                # LOE rcx rbx rsi r12 r13 r14 r15
..B1.26:                        # Preds ..B1.23 ..B1.25
                                # Execution count [1.00e+00]
        negq      %rcx                                          #44.3
        movl      $.L_2__STRING.9, %edi                         #44.3
        addq      $9999999, %rcx                                #44.3
        xorl      %eax, %eax                                    #44.3
        movq      elapsed(%rip), %rdx                           #44.3
...
..B1.27:                        # Preds ..B1.26
                                # Execution count [1.00e+00]
        movl      $.L_2__STRING.10, %edi                        #44.3
        movl      $.L_2__STRING.11, %esi                        #44.3
...
..B1.28:                        # Preds ..B1.27
        ...
        movl      $64, %ecx                                     #44.3
        movq      %rax, %rdi                                    #44.3
        movq      %rax, fileForSpeedups(%rip)                   #44.3
        movl      $.L_2__STRING.12, %esi                        #44.3
        movl      %ecx, %r8d                                    #44.3
        xorl      %eax, %eax                                    #44.3
        movq      programName(%rip), %rdx                       #44.3
        movq      ttbest_rdtsc(%rip), %r9                       #44.3
...
..B2.1:                         # Preds ..B2.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignToThisCore12.25:
..L26:
                                                         #51.1
...
..B3.1:                         # Preds ..B3.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignImagef32.28:
..L29:
                                                         #65.1
        xorl      %esi, %esi                                    #67.6
...
..B4.1:                         # Preds ..B4.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignMatrixf32.31:
..L32:
                                                         #77.1
        movq      %rdi, %r9                                     #77.1
...
..B5.1:                         # Preds ..B5.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignImagei32.34:
..L35:
                                                         #90.1
        movq      %rdi, %r9                                     #90.1
        xorl      %ecx, %ecx                                    #92.6
...
..B6.1:                         # Preds ..B6.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignMatrixi32.37:
..L38:
                                                         #103.1
        xorl      %ecx, %ecx                                    #105.6
...
..B7.1:                         # Preds ..B7.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignMatrixi16.40:
..L41:
                                                         #116.1
        pushq     %r12                                          #116.1
	.cfi_def_cfa_offset 16
...
..B8.1:                         # Preds ..B8.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignImagei16.55:
..L56:
                                                         #128.1
        pushq     %r12                                          #128.1
	.cfi_def_cfa_offset 16
...
..B9.1:                         # Preds ..B9.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_imageTranspose.70:
..L71:
                                                         #140.1
        pushq     %r15                                          #140.1
	.cfi_def_cfa_offset 16
...
..B10.1:                        # Preds ..B10.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignMatrixui16.85:
..L86:
                                                         #152.1
        xorl      %eax, %eax                                    #154.6
...
..B11.1:                        # Preds ..B11.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignMatrixi8.88:
..L89:
                                                         #165.1
        pushq     %r12                                          #165.1
	.cfi_def_cfa_offset 16
...
..B12.1:                        # Preds ..B12.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_assignArrayi32.103:
..L104:
                                                        #178.1
...
..B13.1:                        # Preds ..B13.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_savefloatMatrixFileForOutPuts.106:
..L107:
                                                        #494.56
        pushq     %r12                                          #494.56
	.cfi_def_cfa_offset 16
...
..B14.1:                        # Preds ..B14.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_savefloatMatrixFileName.127:
..L128:
                                                        #509.66
        pushq     %r12                                          #509.66
	.cfi_def_cfa_offset 16
...
..B15.1:                        # Preds ..B15.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_saveintMatrixFileForOutPuts.148:
..L149:
                                                        #524.52
        pushq     %r12                                          #524.52
	.cfi_def_cfa_offset 16
...
..B16.1:                        # Preds ..B16.0
                                # Execution count [1.00e+00]
	.cfi_startproc
..___tag_value_saveintMatrixFileName.169:
..L170:
                                                        #538.62
        pushq     %r12                                          #538.62
	.cfi_def_cfa_offset 16
